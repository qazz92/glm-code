...
- Node.js >= 22.0.0
- [GLM Code](https://github.com/qazz92/glm-code) >= 0.4.0 (stable) installed and accessible in PATH

> **Note for nvm users**: If you use nvm to manage Node.js versions, the SDK may not be able to auto-detect the GLM Code executable. You should explicitly set the `pathToGLMExecutable` option to the full path of the `glm` binary.
...
| `model`                  | `string`                                       | -                | The AI model to use (e.g., `'glm-max'`, `'glm-plus'`, `'glm-turbo'`). Takes precedence over `OPENAI_MODEL` and `GLM_MODEL` environment variables.                                                                                                                                                                                                                                                                                                                                 |
...
```typescript
const query = glm.query('Your prompt', {
  timeout: {
