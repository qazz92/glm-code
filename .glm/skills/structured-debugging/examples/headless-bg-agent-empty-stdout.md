...
A short glm-code case to illustrate two failure modes from `SKILL.md`:
...
`~/.glm/logs` shows the model returned proper text. Stdout was empty.
...
Fix commit: glm-code `feadf052f` — `fix(cli): append newline to text-mode
