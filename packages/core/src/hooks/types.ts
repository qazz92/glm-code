...
export enum HookEventName {
  ...
  // GLM Code extended lifecycle events
  ...
  PreSkillRun = 'PreSkillRun',
  PostSkillRun = 'PostSkillRun',
...
/**
 * All hook event names (GLM Code extended)
 */
export const ALL_HOOK_EVENTS: readonly HookEventName[] = [
  ...
  HookEventName.RunHeartbeat,
  HookEventName.RunBlocked,
  HookEventName.WorkerAssigned,
  HookEventName.WorkerStalled,
  HookEventName.WorkerRecovered,
  HookEventName.TestStarted,
  HookEventName.TestFinished,
  HookEventName.TestFailed,
  HookEventName.RetryNeeded,
  HookEventName.HandoffNeeded,
  HookEventName.NeedsInput,
  HookEventName.PreSkillRun,
  HookEventName.PostSkillRun,
  HookEventName.PermissionGranted,
  HookEventName.PermissionDenied,
] as const;

/**
 * Helper type for typed hook events
 */
export type HookEventOf<T extends HookEventName> = { event: T; timestamp: number; data?: unknown };
