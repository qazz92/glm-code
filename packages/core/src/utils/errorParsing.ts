...
export function parseAndFormatApiError(
  ...
  if (isStructuredError(error)) {
    // GLM OAuth quota errors have their own user-friendly message; don't wrap them
    if (
      error.message.startsWith('GLM OAuth quota exceeded:') ||
      error.message.startsWith('GLM OAuth free tier has been discontinued')
    ) {
