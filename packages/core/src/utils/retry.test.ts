...
describe('retryWithBackoff', () => {
  ...
  describe('GLM OAuth 429 error handling', () => {
    it('should retry for GLM OAuth 429 errors that are throttling-related', async () => {
    ...
    it('should throw immediately for GLM OAuth with insufficient_quota message', async () => {
      ...
      await expect(promise).rejects.toThrow(
        /GLM OAuth free tier has been discontinued/,
      );
    ...
    it('should throw immediately for GLM OAuth with free allocated quota exceeded message', async () => {
    ...
    it('should retry for GLM OAuth with throttling message', async () => {
    ...
    it('should retry for GLM OAuth with throttling error', async () => {
    ...
    it('should throw immediately for GLM OAuth with quota message', async () => {
    ...
    it('should retry normal errors for GLM OAuth (not quota-related)', async () => {
...
describe('isUnattendedMode', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env['GLM_CODE_UNATTENDED_RETRY'];
  });
  ...
  it('should return true when GLM_CODE_UNATTENDED_RETRY=1', () => {
    process.env['GLM_CODE_UNATTENDED_RETRY'] = '1';
    expect(isUnattendedMode()).toBe(true);
  });

  it('should return true when GLM_CODE_UNATTENDED_RETRY=true', () => {
    process.env['GLM_CODE_UNATTENDED_RETRY'] = 'true';
    expect(isUnattendedMode()).toBe(true);
  });
  ...
  it('should return false for non-matching values', () => {
    process.env['GLM_CODE_UNATTENDED_RETRY'] = '0';
    expect(isUnattendedMode()).toBe(false);
    process.env['GLM_CODE_UNATTENDED_RETRY'] = 'false';
    expect(isUnattendedMode()).toBe(false);
    process.env['GLM_CODE_UNATTENDED_RETRY'] = '';
    expect(isUnattendedMode()).toBe(false);
  });
  ...
  it('should use strict matching consistent with parseBooleanEnvFlag', () => {
    ...
    process.env['GLM_CODE_UNATTENDED_RETRY'] = 'yes';
    expect(isUnattendedMode()).toBe(false);
  });
});
