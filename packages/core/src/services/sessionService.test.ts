...
describe('SessionService', () => {
  ...
  let readdirSyncSpy: MockInstance<(path: fs.PathLike) => string[]>;
  ...
  beforeEach(() => {
    ...
    readdirSyncSpy = vi.spyOn(fs, 'readdirSync') as unknown as MockInstance<
  ...
  describe('forkSession', () => {
    ...
    beforeEach(async () => {
      ...
      // `~/.glm` and makes the fork write outside the tmp sandbox.
      ...
      process.env['GLM_RUNTIME_DIR'] = realTmpDir;
      cwd = process.cwd();
