...
const hoistedMockGetGlobalGLMDir = vi.hoisted(() => vi.fn());
vi.mock('../config/storage.js', () => ({
  Storage: {
    getGlobalGLMDir: hoistedMockGetGlobalGLMDir,
  },
}));
...
describe('GitWorktreeService', () => {
  beforeEach(() => {
    ...
    hoistedMockGetGlobalGLMDir.mockReturnValue('/mock-glm');
  ...
  describe('dirty state propagation', () => {
    function makeWorktreeInfo(
      ...
      return {
        id: `${sessionId}/${name}`,
        name,
        path: `/mock-glm/worktrees/${sessionId}/worktrees/${name}`,
