...
describe('convertClaudeToGLMConfig', () => {
  it('should convert basic Claude config', () => {
    ...
    const result = convertClaudeToGLMConfig(claudeConfig);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertClaudeToGLMConfig(invalidConfig)).toThrow();
  });
});
...
describe('convertClaudePluginPackage', () => {
  ...
  it('should successfully convert agent files with Windows CRLF endings', async () => {
    ...
    // Verify: agent file was properly parsed and converted into .glm/agents folder structure
  ...
  it('should convert hooks from Claude plugin format to GLM format with variable substitution', async () => {
...
describe('performVariableReplacement for Claude extensions', () => {
  ...
  it('should replace .claude with .glm in shell scripts', () => {
    ...
    expect(result).toContain('$HOME/.glm/config');
