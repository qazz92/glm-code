...
describe('loggers', () => {
  ...
  describe('logChatCompression', () => {
    beforeEach(() => {
      ...
      vi.spyOn(GLMLogger.prototype, 'logChatCompressionEvent');
    });

    it('logs the chat compression event to GLMLogger', () => {
      ...
      expect(GLMLogger.prototype.logChatCompressionEvent).toHaveBeenCalledWith(
        event,
      );
    });
  ...
  describe('logRipgrepFallback', () => {
    ...
    beforeEach(() => {
      vi.spyOn(GLMLogger.prototype, 'logRipgrepFallbackEvent');
    });
    ...
    it('should log ripgrep fallback event', () => {
      ...
      expect(GLMLogger.prototype.logRipgrepFallbackEvent).toHaveBeenCalled();
  ...
  describe('logMalformedJsonResponse', () => {
    beforeEach(() => {
      vi.spyOn(GLMLogger.prototype, 'logMalformedJsonResponseEvent');
    });
    ...
    it('logs the event to Clearcut and OTEL', () => {
      ...
      expect(
        GLMLogger.prototype.logMalformedJsonResponseEvent,
  ...
  describe('logExtensionInstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(GLMLogger.prototype, 'logExtensionInstallEvent');
    });
    ...
    it('should log extension install event', () => {
      ...
      expect(
        GLMLogger.prototype.logExtensionInstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionUninstall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(GLMLogger.prototype, 'logExtensionUninstallEvent');
    });
    ...
    it('should log extension uninstall event', () => {
      ...
      expect(
        GLMLogger.prototype.logExtensionUninstallEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logExtensionEnable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(GLMLogger.prototype, 'logExtensionEnableEvent');
    });
    ...
    it('should log extension enable event', () => {
      ...
      expect(GLMLogger.prototype.logExtensionEnableEvent).toHaveBeenCalledWith(
        event,
      );
  ...
  describe('logExtensionDisable', () => {
    ...
    beforeEach(() => {
      vi.spyOn(GLMLogger.prototype, 'logExtensionDisableEvent');
    });
    ...
    it('should log extension disable event', () => {
      ...
      expect(
        GLMLogger.prototype.logExtensionDisableEvent,
      ).toHaveBeenCalledWith(event);
  ...
  describe('logHookCall', () => {
    ...
    beforeEach(() => {
      vi.spyOn(GLMLogger, 'getInstance').mockReturnValue(
        mockGLMLogger as unknown as GLMLogger,
      );
      mockGLMLogger.logHookCallEvent.mockClear();
    });

    it('should log a successful hook call to GLMLogger', () => {
      ...
      // Should call GLMLogger
      expect(mockGLMLogger.logHookCallEvent).toHaveBeenCalledWith(event);
    });
    ...
    it('should handle when GLMLogger is not available', () => {
      vi.spyOn(GLMLogger, 'getInstance').mockReturnValue(undefined);
      ...
      // Should not throw when GLMLogger is not available
    ...
    it('should pass the exact event object to GLMLogger', () => {
      const event = new HookCallEvent(
        'PreToolUse',
        'command',
        'test-hook.sh',
      ...
      expect(mockGLMLogger.logHookCallEvent).toHaveBeenCalledTimes(1);
      const passedEvent = mockGLMLogger.logHookCallEvent.mock.calls[0][0];
