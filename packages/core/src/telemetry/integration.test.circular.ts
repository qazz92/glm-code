...
import type { RumEvent } from './glm-logger/event-types.js';
...
describe('Circular Reference Integration Test', () => {
  ...
  it('should handle HttpsProxyAgent-like circular references in glm logging', () => {
    ...
    // Test that GLMLogger can handle this
