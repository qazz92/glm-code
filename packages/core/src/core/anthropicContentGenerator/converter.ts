...
export interface ConvertGeminiRequestToAnthropicOptions {
   ...
   * stray thinking blocks. https://github.com/qazz92/glm-code/issues/3786
   */
...
export class AnthropicContentConverter {
  ...
  async convertGeminiToolsToAnthropic(
    ...
    // `convertGeminiRequestToAnthropic` so a glm-oauth-style hot flip of
    ...
    // hot-mutated — non-glm-oauth providers recreate the generator on
   ...
   * already-satisfying. https://github.com/qazz92/glm-code/issues/3786
   */
