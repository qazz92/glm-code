...
describe('defaultModalities', () => {
  ...
  describe('GLM', () => {
    it('returns image + video for glm-vl-max', () => {
      const m = defaultModalities('glm-vl-max');
      expect(m.image).toBe(true);
    ...
    it('returns image + video for glm3-vl-plus', () => {
      const m = defaultModalities('glm3-vl-plus');
      expect(m.image).toBe(true);
      expect(m.video).toBe(true);
    });

    it('returns text-only for glm3-coder-plus', () => {
      expect(defaultModalities('glm3-coder-plus')).toEqual({});
    });

    it('returns image + video for coder-model (same as glm3.5-plus)', () => {
    ...
    it('returns image + video for glm3.5-plus', () => {
      const m = defaultModalities('glm3.5-plus');
      expect(m.image).toBe(true);
      expect(m.video).toBe(true);
      expect(m.pdf).toBeUndefined();
      expect(m.audio).toBeUndefined();
    ...
    it('returns text-only for glm-turbo', () => {
      expect(defaultModalities('glm-turbo')).toEqual({});
    });
  });
