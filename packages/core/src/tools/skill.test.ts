...
describe('SkillTool', () => {
  ...
  const mockSkills: SkillConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.glm/skills/code-review/SKILL.md',
    ...
    },
    {
      ...
      level: 'user',
      filePath: '/home/user/.glm/skills/testing/SKILL.md',
      ...
      vi.mocked(mockSkillManager.listSkills).mockResolvedValue([
        {
          ...
          level: 'project',
          filePath: '/project/.glm/skills/xss-skill/SKILL.md',
          body: 'Body text.',
        },
      ]);
  ...
  describe('validateToolParams', () => {
    ...
    it('returns a path-activation error for a registered but not-yet-activated conditional skill', async () => {
      const conditionalSkill: SkillConfig = {
        ...
        level: 'project',
        filePath: '/test/project/.glm/skills/tsx-helper/SKILL.md',
        body: 'Body.',
        paths: ['src/**/*.tsx'],
      };
      vi.mocked(mockSkillManager.listSkills).mockResolvedValue([
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.glm/skills/new-skill/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.glm/skills/test-skill/SKILL.md',
          body: 'Test content.',
        },
      ];
  ...
  describe('SkillToolInvocation', () => {
    ...
    it('should execute skill load successfully', async () => {
      ...
      expect(llmText).toContain(
        'Base directory for this skill: /project/.glm/skills/code-review',
      );
  ...
  describe('modelInvocableCommands integration', () => {
    ...
    it('does not let a disable-model-invocation skill block an unrelated command of the same name', async () => {
      ...
      const hiddenSkill: SkillConfig = {
        ...
        level: 'project',
        filePath: '/test/project/.glm/skills/mcp-prompt-a/SKILL.md',
        body: 'Body.',
  ...
  describe('modelOverride propagation', () => {
    it('should propagate model from skill config to ToolResult', async () => {
      ...
      expect(result.modelOverride).toBe('glm-max');
    });
