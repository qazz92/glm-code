 ...
 * - 'project': Stored in `.glm/skills/` within the project directory
 * - 'user': Stored in `~/.glm/skills/` in the user's home directory
...
export interface SkillConfig {
   ...
   * bare model ID (e.g., `glm-coder-plus`), `authType:modelId`
   ...
   * Used to set GLM_SKILL_ROOT environment variable for skill hooks.
   */
  skillRoot?: string;
