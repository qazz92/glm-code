...
import { DEFAULT_GLM_MODEL, MAINLINE_CODER_MODEL } from '../config/models.js';
...
describe('modelConfigResolver', () => {
  describe('resolveModelConfig', () => {
    describe('OpenAI auth type', () => {
      ...
      it('reads GLM_MODEL as fallback for OPENAI_MODEL', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {},
        ...
        expect(result.config.model).toBe('glm-model');
        expect(result.sources['model'].envKey).toBe('GLM_MODEL');
      });
    });

    describe('GLM OAuth auth type', () => {
      it('uses default model for GLM OAuth', () => {
        const result = resolveModelConfig({
        ...
        expect(result.config.model).toBe(DEFAULT_GLM_MODEL);
        expect(result.config.apiKey).toBe('GLM_OAUTH_DYNAMIC_TOKEN');
        expect(result.sources['apiKey'].kind).toBe('computed');
      });

      it('allows coder-model for GLM OAuth', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {
            model: 'coder-model',
      ...
      it('warns and falls back for unsupported GLM OAuth models', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {
      ...
      it('GLM_CODE_API_TIMEOUT_MS applies in GLM OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {},
          settings: {},
          env: {
            GLM_CODE_API_TIMEOUT_MS: '45000',
          },
        });
        ...
        expect(result.sources['timeout'].envKey).toBe(
          'GLM_CODE_API_TIMEOUT_MS',
        );
        expect(result.config.model).toBe(DEFAULT_GLM_MODEL);
      });

      it('modelProvider timeout takes precedence over GLM_CODE_API_TIMEOUT_MS in OAuth', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {},
          settings: {},
      ...
      it('invalid GLM_CODE_API_TIMEOUT_MS ignored in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {},
          settings: {},
          env: {
            GLM_CODE_API_TIMEOUT_MS: 'not-a-number',
          },
        });
      ...
      it('negative GLM_CODE_API_TIMEOUT_MS ignored in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {},
          settings: {},
          env: {
            GLM_CODE_API_TIMEOUT_MS: '-100',
          },
        });
      ...
      it('zero GLM_CODE_API_TIMEOUT_MS ignored in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {},
          settings: {},
          env: {
            GLM_CODE_API_TIMEOUT_MS: '0',
          },
        });
      ...
      it('GLM_CODE_API_TIMEOUT_MS works with float value in OAuth', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {},
          settings: {},
          env: {
            GLM_CODE_API_TIMEOUT_MS: '12345.67',
          },
        });
      ...
      it('GLM_CODE_API_TIMEOUT_MS works with proxy in OAuth path', () => {
        const result = resolveModelConfig({
          authType: AuthType.GLM_OAUTH,
          cli: {},
          settings: {},
          env: {
            GLM_CODE_API_TIMEOUT_MS: '60000',
          },
    ...
    describe('generation config resolution', () => {
      ...
      it('GLM_CODE_API_TIMEOUT_MS env var overrides settings timeout', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
          ...
          env: {
            OPENAI_API_KEY: 'key',
            GLM_CODE_API_TIMEOUT_MS: '900000',
          },
        });
      ...
      it('modelProvider timeout wins over GLM_CODE_API_TIMEOUT_MS', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {},
      ...
      it('GLM_CODE_API_TIMEOUT_MS applies when modelProvider has no timeout', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {},
      ...
      it('ignores invalid GLM_CODE_API_TIMEOUT_MS values', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
          ...
          env: {
            OPENAI_API_KEY: 'key',
            GLM_CODE_API_TIMEOUT_MS: 'invalid',
          },
        });
      ...
      it('ignores negative or zero GLM_CODE_API_TIMEOUT_MS values', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
      ...
      it('GLM_CODE_API_TIMEOUT_MS works for Anthropic auth type', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_ANTHROPIC,
          cli: {},
          settings: {},
          env: {
            ...
            GLM_CODE_API_TIMEOUT_MS: '600000',
          },
        });
      ...
      it('handles extremely large timeout values safely', () => {
        const result = resolveModelConfig({
          ...
          env: {
            OPENAI_API_KEY: 'key',
            GLM_CODE_API_TIMEOUT_MS: '999999999',
          },
        });
      ...
      it('handles whitespace-padded env values', () => {
        const result = resolveModelConfig({
          ...
          env: {
            OPENAI_API_KEY: 'key',
            GLM_CODE_API_TIMEOUT_MS: ' 300000 ',
          },
        });
      ...
      it('ignores negative GLM_CODE_API_TIMEOUT_MS values', () => {
        const result = resolveModelConfig({
          authType: AuthType.USE_OPENAI,
          cli: {},
          settings: {
  ...
  describe('validateModelConfig', () => {
    ...
    it('always passes for GLM OAuth', () => {
      const result = validateModelConfig({
        authType: AuthType.GLM_OAUTH,
  ...
  describe('[Regression] timeout env override refactor', () => {
    it('[Regression] OAuth path must apply GLM_CODE_API_TIMEOUT_MS (was broken before fix #3629)', () => {
      // Guards against the original bug where resolveGLMOAuthConfig()
      ...
      expect(result.sources['timeout']).toBeDefined();
      expect(result.sources['timeout'].kind).toBe('env');
      expect(result.sources['timeout'].envKey).toBe('GLM_CODE_API_TIMEOUT_MS');
      expect(result.config.model).toBe(DEFAULT_GLM_MODEL);
    });

    it('[Regression] non-OAuth path must apply GLM_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        settings: { apiKey: 'key' },
  ...
  describe('[Additional] timeout env override edge cases', () => {
    it('handles scientific notation in GLM_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        settings: { apiKey: 'key' },
    ...
    it('handles hex values in GLM_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        ...
        env: {
          OPENAI_API_KEY: 'key',
          GLM_CODE_API_TIMEOUT_MS: '0x2BF20', // 180000 in hex
        },
      });
    ...
    it('ignores empty string GLM_CODE_API_TIMEOUT_MS', () => {
      const result = resolveModelConfig({
        authType: AuthType.USE_OPENAI,
        cli: {},
        settings: { apiKey: 'key', generationConfig: { timeout: 30000 } },
    ...
    it('applies env override for every supported auth type', () => {
      ...
      for (const { type, env } of authTypes) {
        const result = resolveModelConfig({
          ...
          env: { ...env, GLM_CODE_API_TIMEOUT_MS: '99999' },
        });
