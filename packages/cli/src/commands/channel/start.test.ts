...
const invokeStartHandler = async (
  ...
  await handler({ _: [], $0: 'glm', ...args } as StartCommandArgs);
};

const mockParsedChannelConfig = {
  cwd: '/tmp/glm-channel-test',
...
beforeEach(() => {
  ...
  mockFindCliEntryPath.mockReturnValue('/tmp/glm-cli-entry.js');
