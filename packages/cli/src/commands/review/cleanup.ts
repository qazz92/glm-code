...
//   - Remove the temporary worktree at .glm/tmp/review-pr-<n>.
//   - Delete the local branch ref glm-review/pr-<n>.
//   - Remove any .glm/tmp/glm-review-<target>-* side files.
//
...
function runCleanup(target: string): void {
  ...
  // --- Per-target side files (under .glm/tmp/) -------------------------
