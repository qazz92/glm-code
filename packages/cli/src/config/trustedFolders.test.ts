...
import { FatalConfigError, ideContextStore } from '@glm-code/core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use GLM_CODE_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['GLM_CODE_TRUSTED_FOLDERS_PATH'] = customPath;
