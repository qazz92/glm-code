...
export function getTrustedFoldersPath(): string {
  if (process.env['GLM_CODE_TRUSTED_FOLDERS_PATH']) {
    return process.env['GLM_CODE_TRUSTED_FOLDERS_PATH'];
  }
  ...
  return path.join(Storage.getGlobalGLMDir(), TRUSTED_FOLDERS_FILENAME);
}
