...
const SETTINGS_SCHEMA = {
  ...
  general: {
    ...
    properties: {
      ...
      gitCoAuthor: {
        ...
        description:
          'Attribution added to git commits and pull requests created through GLM Code.',
        showInDialog: false,
        ...
        // until they run glm once. Config.normalizeGitCoAuthor handles
        ...
        properties: {
          commit: {
            ...
            default: true,
            description:
              'Add a Co-authored-by trailer to git commit messages AND attach a per-file AI-attribution git note (`refs/notes/ai-attribution`) for commits made through GLM Code. Disabling skips both.',
            showInDialog: true,
          },
          pr: {
            type: 'boolean',
            ...
            default: true,
            description:
              'Append a GLM Code attribution line to PR descriptions when running `gh pr create`.',
            showInDialog: true,
          },
        },
      },
      ...
      language: {
        ...
        description:
          ...
          'in ~/.glm/locales/ (e.g., ~/.glm/locales/es.js).',
        showInDialog: true,
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show GLM Code status and thoughts in the terminal window title',
        showInDialog: false,
      },
      hideTips: {
        type: 'boolean',
      ...
      enableUserFeedback: {
        ...
        default: true,
        description:
          'Show optional feedback dialog after conversations to help improve GLM performance.',
        showInDialog: true,
      },
  ...
  fastModel: {
    ...
    default: '',
    description:
      'Model used for generating prompt suggestions and speculative execution. Leave empty to use the main model. A smaller/faster model (e.g., glm3-coder-flash) reduces latency and cost.',
    showInDialog: true,
  },
      ...
      generationConfig: {
        ...
        properties: {
          ...
          splitToolMedia: {
            ...
            default: false,
            description:
              'When true, media (images / audio / video / files) returned by MCP tool calls is split into a follow-up user message instead of being embedded in the tool message. Required for strict OpenAI-compatible servers (e.g., LM Studio) that reject non-text content on `role: "tool"` messages with HTTP 400 "Invalid \'messages\' in payload". Default false preserves the prior behavior for permissive providers. See qazz92/glm-code#3616.',
            parentKey: 'generationConfig',
            showInDialog: false,
          },
          schemaCompliance: {
          ...
          contextWindowSize: {
            ...
            default: undefined,
            description:
              "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from GLM Code's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
            parentKey: 'generationConfig',
            showInDialog: false,
          },
        },
  ...
  modelPricing: {
    ...
    default: undefined as
      ...
      | undefined,
    description:
      'Optional per-model pricing for cost estimation in /stats model. Example: {"glm3-coder": {"inputPerMillionTokens": 0.30, "outputPerMillionTokens": 1.20}}',
    showInDialog: false,
  },
    ...
    properties: {
      ...
      fileFiltering: {
        ...
        properties: {
          ...
          respectGLMIgnore: {
            type: 'boolean',
            label: 'Respect .glmignore',
            category: 'Context',
            requiresRestart: true,
            default: true,
            description: 'Respect .glmignore files when searching',
            showInDialog: true,
          },
  ...
  tools: {
    ...
    properties: {
      ...
      sandboxImage: {
        ...
        default: undefined as string | undefined,
        description:
          'Sandbox image URI used by Docker/Podman when --sandbox-image and GLM_SANDBOX_IMAGE are not set.',
        showInDialog: false,
      },
      toolSearch: {
        type: 'object',
    ...
    properties: {
      ...
      runtimeOutputDir: {
        ...
        description:
          ...
          'Config files remain at ~/.glm (or GLM_HOME if set). Env var GLM_RUNTIME_DIR takes priority.',
        showInDialog: false,
      },
    },
  },
      ...
      arena: {
        ...
        properties: {
          worktreeBaseDir: {
            ...
            default: undefined as string | undefined,
            description:
              'Custom base directory for Arena worktrees. Defaults to ~/.glm/arena.',
            showInDialog: false,
          },
          preserveArtifacts: {
            type: 'boolean',
  ...
  experimental: {
    ...
    properties: {
      cron: {
        ...
        default: false,
        description:
          'Enable in-session cron/loop tools (experimental). When enabled, the model can create recurring prompts using cron_create, cron_list, and cron_delete tools. Can also be enabled via GLM_CODE_ENABLE_CRON=1 environment variable.',
        showInDialog: true,
      },
