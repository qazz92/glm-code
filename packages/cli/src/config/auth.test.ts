...
describe('validateAuthMethod', () => {
  ...
  it('should return an error for GLM_OAUTH (free tier discontinued)', () => {
    const result = validateAuthMethod(AuthType.GLM_OAUTH);
  ...
  it('should use config.getModelsConfig().getModel() when Config is provided', () => {
    ...
    } as unknown as import('@glm-code/core').Config;
