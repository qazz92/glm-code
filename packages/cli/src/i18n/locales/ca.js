...
// Traduccions en català per al CLI de GLM Code per Jordi Mas i Hernàndez <jmas@softcatala.org>
...
export default {
  ...
  'for help on GLM Code': 'per a ajuda sobre GLM Code',
  ...
  'Analyzes the project and creates a tailored GLM.md file.':
    'Analitza el projecte i crea un fitxer GLM.md personalitzat.',
  'List available GLM Code tools. Usage: /tools [desc]':
    'Llistar les eines disponibles de GLM Code. Ús: /tools [desc]',
  'List available skills.': 'Llistar les habilitats disponibles.',
  'Available GLM Code CLI tools:': 'Eines del CLI de GLM Code disponibles:',
  ...
  'open full GLM Code documentation in your browser':
    'obrir la documentació completa de GLM Code al navegador',
  ...
  // ============================================================================
  'Project Level (.glm/agents/)': 'Nivell de projecte (.glm/agents/)',
  'User Level (~/.glm/agents/)': "Nivell d'usuari (~/.glm/agents/)",
  ...
  'Generate with GLM Code (Recommended)': 'Generar amb GLM Code (Recomanat)',
  ...
  'View and edit GLM Code settings':
    'Veure i editar la configuració de GLM Code',
  Settings: 'Configuració',
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    'Per veure els canvis, cal reiniciar GLM Code. Premeu r per sortir i aplicar els canvis ara.',
  // ============================================================================
  ...
  'How is GLM doing this session? (optional)':
    'Com va GLM en aquesta sessió? (opcional)',
  Bad: 'Malament',
  Fine: 'Bé',
  Good: 'Molt bé',
  Dismiss: 'Descartar',
  ...
  'Respect .glmignore': 'Respectar .glmignore',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    'Aquesta extensió afegirà informació al vostre context GLM.md usant {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    'Esteu instal·lant una extensió des de {{originSource}}. Algunes funcions poden no funcionar perfectament amb GLM Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    "La integració de l'IDE no és compatible en el vostre entorn actual. Per usar aquesta funció, executeu GLM Code en un dels IDEs compatibles: VS Code o bifurcacions de VS Code.",
  ...
  // Ordres - Hooks
  // ============================================================================
  'Manage GLM Code hooks': 'Gestionar els hooks de GLM Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    'Aquest menú és de només lectura. Per afegir o modificar hooks, editeu settings.json directament o demaneu-ho a GLM Code.',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    'Per afegir hooks, editeu settings.json directament o demaneu-ho a GLM.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    'Per modificar o eliminar aquest hook, editeu settings.json directament o demaneu ajuda a GLM.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    'Per tornar a activar els hooks, elimineu "disableAllHooks" de settings.json o demaneu-ho a GLM Code.',
  Project: 'Projecte',
  User: 'Usuari',
  Skill: 'Habilitat',
  System: 'Sistema',
  ...
  'Right before GLM Code concludes its response':
    'Immediatament abans que GLM Code conclou la seva resposta',
  ...
  'stdout shown to GLM': 'stdout mostrat a GLM',
  ...
  'Run glm --debug to see error logs':
    "Executeu glm --debug per veure els registres d'errors",
  ...
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    'Generar un resum del projecte i desar-lo a .glm/PROJECT_SUMMARY.md',
  ...
  'Successfully added GLM.md files from the following directories if there are:\n- {{directories}}':
    "S'han afegit correctament els fitxers GLM.md dels directoris següents si n'hi ha:\n- {{directories}}",
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'El nivell gratuït de GLM OAuth es va descontinuar el 15-04-2026. Seleccioneu Coding Plan o API Key en el seu lloc.',
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    "El nivell gratuït de GLM OAuth es va descontinuar el 15-04-2026. Seleccioneu un model d'un altre proveïdor o executeu /auth per canviar.",
  '\n⚠ GLM OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ El nivell gratuït de GLM OAuth es va descontinuar el 15-04-2026. Seleccioneu una altra opció.\n',
  'Paid · Up to 6,000 requests/5 hrs · All Alibaba Cloud Coding Plan Models':
    "De pagament · Fins a 6.000 sol·licituds/5 h · Tots els models de Coding Plan d'z.ai",
  'Alibaba Cloud Coding Plan': "Coding Plan d'z.ai",
  ...
  'GLM OAuth Authentication': 'Autenticació GLM OAuth',
  ...
  'GLM OAuth Authentication Timeout':
    "Temps d'espera de l'autenticació GLM OAuth esgotat",
  ...
  'Waiting for GLM OAuth authentication...':
    "Esperant l'autenticació GLM OAuth...",
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valor de GLM_DEFAULT_AUTH_TYPE no vàlid: "{{value}}". Els valors vàlids són: {{validValues}}',
  // ============================================================================
  // Diàlegs - Model
  // ============================================================================
  ...
  "GLM Code won't ask before using allowed tools.":
    "GLM Code no preguntarà abans d'usar les eines permeses.",
  'GLM Code will ask before using these tools.':
    "GLM Code preguntarà abans d'usar aquestes eines.",
  'GLM Code is not allowed to use denied tools.':
    'GLM Code no té permís per usar les eines denegades.',
  ...
  'Checked in at .glm/settings.json': 'Registrat a .glm/settings.json',
  'User settings': "Configuració d'usuari",
  'Saved in at ~/.glm/settings.json': 'Desat a ~/.glm/settings.json',
  ...
  'GLM Code can read files in the workspace, and make edits when auto-accept edits is on.':
    "GLM Code pot llegir fitxers a l'espai de treball i fer canvis quan l'acceptació automàtica de canvis està activada.",
  'GLM Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    "GLM Code podrà llegir fitxers en aquest directori i fer canvis quan l'acceptació automàtica de canvis està activada.",
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    'Podeu executar qualsevol ordre shell des de GLM Code usant ! (p. ex. !ls).',
  ...
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    'Podeu reprendre una conversa anterior executant glm --continue o glm --resume.',
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    'Afegiu un fitxer GLM.md per donar a GLM Code un context persistent del projecte.',
  ...
  'Authenticate using GLM OAuth': 'Autenticar-se usant GLM OAuth',
  'Authenticate using Alibaba Cloud Coding Plan':
    "Autenticar-se usant el Coding Plan d'z.ai",
  ...
  'Starting GLM OAuth authentication...':
    "Iniciant l'autenticació GLM OAuth...",
  'Successfully authenticated with GLM OAuth.':
    "S'ha autenticat correctament amb GLM OAuth.",
  'Failed to authenticate with GLM OAuth: {{error}}':
    'Error en autenticar-se amb GLM OAuth: {{error}}',
  'Processing Alibaba Cloud Coding Plan authentication...':
    "Processant l'autenticació de Coding Plan d'z.ai...",
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    "S'ha autenticat correctament amb el Coding Plan d'z.ai.",
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - Autenticar-se amb GLM OAuth (descontinuat)',
  'Or simply run:': 'O simplement executeu:',
  '  glm auth                - Interactive authentication setup\n':
    "  glm auth                - Configuració interactiva de l'autenticació\n",
  '✓ Authentication Method: GLM OAuth': "✓ Mètode d'autenticació: GLM OAuth",
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'El nivell gratuït de GLM OAuth es va descontinuar el 15-04-2026. Executeu /auth per canviar a Coding Plan, OpenRouter, Fireworks AI o un altre proveïdor.',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    "✓ Mètode d'autenticació: Coding Plan d'z.ai",
  ...
  "Set up GLM Code's status line UI":
    "Configurar la interfície de la barra d'estat de GLM Code",
