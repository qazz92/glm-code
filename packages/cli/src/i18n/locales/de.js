...
// German translations for GLM Code CLI
// Deutsche Übersetzungen für GLM Code CLI
...
export default {
  ...
  'for help on GLM Code': 'für Hilfe zu GLM Code',
  ...
  // Commands - General
  // ============================================================================
  'Analyzes the project and creates a tailored GLM.md file.':
    'Analysiert das Projekt und erstellt eine maßgeschneiderte GLM.md-Datei.',
  'List available GLM Code tools. Usage: /tools [desc]':
    'Verfügbare GLM Code Werkzeuge auflisten. Verwendung: /tools [desc]',
  'List available skills.': 'Verfügbare Skills auflisten.',
  'Available GLM Code CLI tools:': 'Verfügbare GLM Code CLI-Werkzeuge:',
  ...
  'open full GLM Code documentation in your browser':
    'Vollständige GLM Code Dokumentation im Browser öffnen',
  ...
  // ============================================================================
  'Project Level (.glm/agents/)': 'Projektebene (.glm/agents/)',
  'User Level (~/.glm/agents/)': 'Benutzerebene (~/.glm/agents/)',
  ...
  'Generate with GLM Code (Recommended)':
    'Mit GLM Code generieren (Empfohlen)',
  ...
  // ============================================================================
  'View and edit GLM Code settings':
    'GLM Code Einstellungen anzeigen und bearbeiten',
  Settings: 'Einstellungen',
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    'Um Änderungen zu sehen, muss GLM Code neu gestartet werden. Drücken Sie r, um jetzt zu beenden und Änderungen anzuwenden.',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Vim-Modus',
  ...
  'How is GLM doing this session? (optional)':
    'Wie macht sich GLM in dieser Sitzung? (optional)',
  Bad: 'Schlecht',
  Fine: 'In Ordnung',
  Good: 'Gut',
  Dismiss: 'Ignorieren',
  ...
  'Respect .glmignore': '.glmignore beachten',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    'Diese Erweiterung wird Informationen zu Ihrem GLM.md-Kontext mit {{fileName}} hinzufügen',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    'Sie installieren eine Erweiterung von {{originSource}}. Einige Funktionen funktionieren möglicherweise nicht perfekt mit GLM Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    'IDE-Integration wird in Ihrer aktuellen Umgebung nicht unterstützt. Um diese Funktion zu nutzen, führen Sie GLM Code in einer dieser unterstützten IDEs aus: VS Code oder VS Code-Forks.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage GLM Code hooks': 'GLM Code-Hooks verwalten',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    'Dieses Menü ist schreibgeschützt. Um Hooks hinzuzufügen oder zu ändern, bearbeiten Sie settings.json direkt oder fragen Sie GLM Code.',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    'Um Hooks hinzuzufügen, bearbeiten Sie settings.json direkt oder fragen Sie GLM.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    'Um diesen Hook zu ändern oder zu entfernen, bearbeiten Sie settings.json direkt oder fragen Sie GLM.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    'Um Hooks wieder zu aktivieren, entfernen Sie "disableAllHooks" aus settings.json oder fragen Sie GLM Code.',
  // Hooks - Source
  Project: 'Projekt',
  User: 'Benutzer',
  Skill: 'Skill',
  ...
  'Right before GLM Code concludes its response':
    'Direkt bevor GLM Code seine Antwort abschließt',
  ...
  'stdout shown to GLM': 'stdout dem GLM anzeigen',
  ...
  // Commands - Summary
  // ============================================================================
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    'Projektzusammenfassung generieren und in .glm/PROJECT_SUMMARY.md speichern',
  ...
  'Successfully added GLM.md files from the following directories if there are:\n- {{directories}}':
    'GLM.md-Dateien aus folgenden Verzeichnissen erfolgreich hinzugefügt, falls vorhanden:\n- {{directories}}',
  ...
  'Run glm --debug to see error logs':
    'Führen Sie glm --debug aus, um Fehlerprotokolle anzuzeigen',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Das kostenlose GLM OAuth-Kontingent wurde am 2026-04-15 eingestellt. Bitte wählen Sie Coding Plan oder API Key.',
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'Das kostenlose GLM OAuth-Angebot wurde am 2026-04-15 eingestellt. Bitte wählen Sie ein Modell eines anderen Anbieter oder führen Sie /auth aus, um zu wechseln.',
  '\n⚠ GLM OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ Das kostenlose GLM OAuth-Kontingent wurde am 2026-04-15 eingestellt. Bitte wählen Sie eine andere Option.\n',
  'Paid \u00B7 Up to 6,000 requests/5 hrs \u00B7 All Alibaba Cloud Coding Plan Models':
    'Kostenpflichtig \u00B7 Bis zu 6.000 Anfragen/5 Std. \u00B7 Alle z.ai Coding Plan Modelle',
  'Alibaba Cloud Coding Plan': 'z.ai Coding Plan',
  ...
  'GLM OAuth Authentication': 'GLM OAuth-Authentifizierung',
  'Please visit this URL to authorize:':
    'Bitte besuchen Sie diese URL zur Autorisierung:',
  'Waiting for authorization': 'Warten auf Autorisierung',
  'Time remaining:': 'Verbleibende Zeit:',
  'GLM OAuth Authentication Timeout':
    'GLM OAuth-Authentifizierung abgelaufen',
  ...
  'Waiting for GLM OAuth authentication...':
    'Warten auf GLM OAuth-Authentifizierung...',
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Ungültiger GLM_DEFAULT_AUTH_TYPE-Wert: "{{value}}". Gültige Werte sind: {{validValues}}',
  // ============================================================================
  // Dialogs - Model
  // ============================================================================
  ...
  Deny: 'Verweigern',
  Workspace: 'Arbeitsbereich',
  "GLM Code won't ask before using allowed tools.":
    'GLM Code fragt nicht, bevor erlaubte Tools verwendet werden.',
  'GLM Code will ask before using these tools.':
    'GLM Code fragt, bevor diese Tools verwendet werden.',
  'GLM Code is not allowed to use denied tools.':
    'GLM Code darf verweigerte Tools nicht verwenden.',
  ...
  'Checked in at .glm/settings.json': 'Eingecheckt in .glm/settings.json',
  'User settings': 'Benutzereinstellungen',
  'Saved in at ~/.glm/settings.json': 'Gespeichert in ~/.glm/settings.json',
  ...
  'GLM Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'GLM Code kann Dateien im Arbeitsbereich lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  'GLM Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'GLM Code kann Dateien in diesem Verzeichnis lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    'Sie können beliebige Shell-Befehle in GLM Code mit ! ausführen (z. B. !ls).',
  'Type / to open the command popup; Tab autocompletes slash commands and saved prompts.':
    'Geben Sie / ein, um das Befehlsmenü zu öffnen; Tab vervollständigt Slash-Befehle und gespeicherte Prompts.',
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    'Sie können eine frühere Unterhaltung mit glm --continue oder glm --resume fortsetzen.',
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    'Fügen Sie eine GLM.md-Datei hinzu, um GLM Code dauerhaften Projektkontext zu geben.',
  ...
  'Authenticate using GLM OAuth': 'Mit GLM OAuth authentifizieren',
  'Authenticate using Alibaba Cloud Coding Plan':
    'Mit z.ai Coding Plan authentifizieren',
  ...
  'Starting GLM OAuth authentication...':
    'GLM OAuth-Authentifizierung wird gestartet...',
  'Successfully authenticated with GLM OAuth.':
    'Erfolgreich mit GLM OAuth authentifiziert.',
  'Failed to authenticate with GLM OAuth: {{error}}':
    'Authentifizierung mit GLM OAuth fehlgeschlagen: {{error}}',
  'Processing Alibaba Cloud Coding Plan authentication...':
    'z.ai Coding Plan-Authentifizierung wird verarbeitet...',
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    'Erfolgreich mit z.ai Coding Plan authentifiziert.',
  'Failed to authenticate with Coding Plan: {{error}}':
    'Authentifizierung mit Coding Plan fehlgeschlagen: {{error}}',
  '阿里云百炼 (aliyun.com)': 'z.ai (z.ai)',
  Global: 'Global',
  'Alibaba Cloud (alibabacloud.com)': 'z.ai (z.ai)',
  'Select region for Coding Plan:': 'Region für Coding Plan auswählen:',
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - Mit GLM OAuth authentifizieren (eingestellt)',
  'Or simply run:': 'Oder einfach ausführen:',
  '  glm auth                - Interactive authentication setup\n':
    '  glm auth                - Interaktive Authentifizierungseinrichtung\n',
  '✓ Authentication Method: GLM OAuth':
    '✓ Authentifizierungsmethode: GLM OAuth',
  '  Type: Free tier (discontinued 2026-04-15)':
    '  Typ: Kostenloses Kontingent (eingestellt 2026-04-15)',
  '  Limit: No longer available': '  Limit: Nicht mehr verfügbar',
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Das kostenlose GLM OAuth-Kontingent wurde am 2026-04-15 eingestellt. Führen Sie /auth aus, um zu Coding Plan, OpenRouter, Fireworks AI oder einem anderen Anbieter zu wechseln.',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    '✓ Authentifizierungsmethode: z.ai Coding Plan',
  'Global - Alibaba Cloud': 'Global - z.ai',
  ...
  '⚠️  Authentication Method: Alibaba Cloud Coding Plan (Incomplete)':
    '⚠️  Authentifizierungsmethode: z.ai Coding Plan (Unvollständig)',
  '  Issue: API key not found in environment or settings\n':
    '  Problem: API Key nicht in Umgebung oder Einstellungen gefunden\n',
  '  Run `glm auth coding-plan` to re-configure.\n':
    '  Führen Sie `glm auth coding-plan` aus, um neu zu konfigurieren.\n',
  ...
  "Set up GLM Code's status line UI": 'GLM Codes Statusleisten-UI einrichten',
