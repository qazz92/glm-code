...
// English translations for GLM Code CLI
...
export default {
  ...
  'for help on GLM Code': 'for help on GLM Code',
  ...
  'Available GLM Code CLI tools:': 'Available GLM Code CLI tools:',
  ...
  // ============================================================================
  'Project Level (.glm/agents/)': 'Project Level (.glm/agents/)',
  'User Level (~/.glm/agents/)': 'User Level (~/.glm/agents/)',
  ...
  // ============================================================================
  'View and edit GLM Code settings': 'View and edit GLM Code settings',
  Settings: 'Settings',
  ...
  'Respect .glmignore': 'Respect .glmignore',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage GLM Code hooks': 'Manage GLM Code hooks',
  ...
  'block processing, erase original prompt, and show stderr to user only':
    'block processing, erase original prompt, and show stderr to user only',
  'stdout shown to GLM': 'stdout shown to GLM',
  ...
  'Add MCP servers to your settings to get started.':
    'Add MCP servers to your settings to get started.',
  'Run glm --debug to see error logs': 'Run glm --debug to see error logs',
  ...
  'Pay-as-you-go tokens \u00B7 Configure ModelStudio standard API key':
    'Pay-as-you-go tokens \u00B7 Configure z.ai standard API key',
  ...
  'Authentication is enforced to be {{enforcedType}}, but you are currently using {{currentType}}.':
    'Authentication is enforced to be {{enforcedType}}, but you are currently using {{currentType}}.',
  'GLM OAuth Authentication': 'GLM OAuth Authentication',
  ...
  'GLM OAuth Authentication Timeout': 'GLM OAuth Authentication Timeout',
  ...
  'Checked in at .glm/settings.json': 'Checked in at .glm/settings.json',
  'User settings': 'User settings',
  'Saved in at ~/.glm/settings.json': 'Saved in at ~/.glm/settings.json',
  ...
  'New model configurations are available for Alibaba Cloud Coding Plan. Update now?':
    'New model configurations are available for z.ai Coding Plan. Update now?',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: Navigate | Enter: Select | Esc: Cancel',
  'Authenticate using GLM OAuth': 'Authenticate using GLM OAuth',
  'Authenticate using Alibaba Cloud Coding Plan':
    'Authenticate using z.ai Coding Plan',
  ...
  'Processing Alibaba Cloud Coding Plan authentication...':
    'Processing z.ai authentication...',
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    'Successfully authenticated with z.ai.',
  ...
  '  glm auth                - Interactive authentication setup\n':
    '  glm auth                - Interactive authentication setup\n',
  '✓ Authentication Method: GLM OAuth': '✓ Authentication Method: GLM OAuth',
  ...
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    '✓ Authentication Method: z.ai Coding Plan',
  '中国 (China) - 阿里云百炼': '中国 (China) - z.ai',
  ...
  '⚠️  Authentication Method: Alibaba Cloud Coding Plan (Incomplete)':
    '⚠️  Authentication Method: z.ai Coding Plan (Incomplete)',
  ...
  'Not in plan mode. Use "/plan" to enter plan mode first.':
    'Not in plan mode. Use "/plan" to enter plan mode first.',
  "Set up GLM Code's status line UI": "Set up GLM Code's status line UI",
