...
// Chinese translations for GLM Code CLI
...
export default {
  ...
  'for help on GLM Code': '获取 GLM Code 帮助',
  ...
  // ============================================================================
  'Project Level (.glm/agents/)': '项目级 (.glm/agents/)',
  'User Level (~/.glm/agents/)': '用户级 (~/.glm/agents/)',
  ...
  'Generate with GLM Code (Recommended)': '使用 GLM Code 生成（推荐）',
  ...
  // ============================================================================
  'View and edit GLM Code settings': '查看和编辑 GLM Code 设置',
  Settings: '设置',
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必须重启 GLM Code。按 r 退出并立即应用更改。',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Vim 模式',
  ...
  'How is GLM doing this session? (optional)': 'GLM 这次表现如何？（可选）',
  Bad: '不满意',
  Fine: '还行',
  Good: '满意',
  Dismiss: '忽略',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    '此扩展将使用 {{fileName}} 向您的 GLM.md 上下文追加信息',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    '您正在安装来自 {{originSource}} 的扩展。某些功能可能无法完美兼容 GLM Code。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 GLM Code：VS Code 或 VS Code 分支版本。',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    '此菜单为只读。要添加或修改 Hook，请直接编辑 settings.json 或询问 GLM Code。',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    '要添加 Hook，请直接编辑 settings.json 或询问 GLM。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    '要修改或删除此 Hook，请直接编辑 settings.json 或询问 GLM。',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    '要重新启用 Hook，请从 settings.json 中删除 "disableAllHooks" 或询问 GLM Code。',
  // Hooks - Source
  Project: '项目',
  User: '用户',
  Skill: '技能',
  ...
  'Right before GLM Code concludes its response': 'GLM Code 结束响应之前',
  ...
  'stdout shown to GLM': '向 GLM 显示 stdout',
  ...
  'Run glm --debug to see error logs': '运行 glm --debug 查看错误日志',
  ...
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    '生成项目摘要并保存到 .glm/PROJECT_SUMMARY.md',
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '无效的 GLM_DEFAULT_AUTH_TYPE 值："{{value}}"。有效值为：{{validValues}}',
  // ============================================================================
  // Dialogs - Model
  // ============================================================================
  'Select Model': '选择模型',
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    '在 GLM Code 中使用 ! 可运行任意 shell 命令（例如 !ls）。',
  ...
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    '运行 glm --continue 或 glm --resume 可继续之前的会话。',
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    '添加 GLM.md 文件，为 GLM Code 提供持久的项目上下文。',
  ...
  // Exit Screen / Stats
  // ============================================================================
  'Agent powering down. Goodbye!': 'GLM Code 正在关闭，再见！',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: 导航 | Enter: 选择 | Esc: 取消',
  'Authenticate using GLM OAuth': '使用 GLM OAuth 进行认证',
  'Authenticate using Alibaba Cloud Coding Plan':
    '使用z.ai Coding Plan 进行认证',
  ...
  'Starting GLM OAuth authentication...': '正在启动 GLM OAuth 认证...',
  'Successfully authenticated with GLM OAuth.': '已成功通过 GLM OAuth 认证。',
  'Failed to authenticate with GLM OAuth: {{error}}':
    'GLM OAuth 认证失败：{{error}}',
  'Processing Alibaba Cloud Coding Plan authentication...':
    '正在处理z.ai Coding Plan 认证...',
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    '已成功通过z.ai Coding Plan 认证。',
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - 使用 GLM OAuth 登录（已停用）',
  'Or simply run:': '或者直接运行：',
  '  glm auth                - Interactive authentication setup\n':
    '  glm auth                - 交互式认证配置\n',
  '✓ Authentication Method: GLM OAuth': '✓ 认证方式：GLM OAuth',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'GLM OAuth 免费额度已于 2026-04-15 停用。请运行 /auth 切换到 Coding Plan、OpenRouter、Fireworks AI 或其他服务商。',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    '✓ 认证方式：z.ai Coding Plan',
  ...
  "Set up GLM Code's status line UI": '配置 GLM Code 的状态栏',
