...
// Portuguese translations for GLM Code CLI (pt-BR)
...
export default {
  ...
  'for help on GLM Code': 'para ajuda sobre o GLM Code',
  ...
  'Analyzes the project and creates a tailored GLM.md file.':
    'Analisa o projeto e cria um arquivo GLM.md personalizado.',
  'List available GLM Code tools. Usage: /tools [desc]':
    'Listar ferramentas GLM Code disponíveis. Uso: /tools [desc]',
  'List available skills.': 'Listar habilidades disponíveis.',
  'Available GLM Code CLI tools:': 'Ferramentas CLI do GLM Code disponíveis:',
  ...
  'open full GLM Code documentation in your browser':
    'abrir documentação completa do GLM Code no seu navegador',
  ...
  // ============================================================================
  'Project Level (.glm/agents/)': 'Nível de Projeto (.glm/agents/)',
  'User Level (~/.glm/agents/)': 'Nível de Usuário (~/.glm/agents/)',
  ...
  'Generate with GLM Code (Recommended)': 'Gerar com GLM Code (Recomendado)',
  ...
  // ============================================================================
  'View and edit GLM Code settings': 'Ver e editar configurações do GLM Code',
  Settings: 'Configurações',
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    'Para ver as alterações, o GLM Code deve ser reiniciado. Pressione r para sair e aplicar as alterações agora.',
  // ============================================================================
  // Settings Labels
  // ============================================================================
  'Vim Mode': 'Modo Vim',
  ...
  'How is GLM doing this session? (optional)':
    'Como o GLM está se saindo nesta sessão? (opcional)',
  Bad: 'Ruim',
  Fine: 'Bom',
  Good: 'Ótimo',
  Dismiss: 'Ignorar',
  ...
  'Respect .glmignore': 'Respeitar .glmignore',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    'Esta extensão anexará informações ao seu contexto GLM.md usando {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    'Você está instalando uma extensão de {{originSource}}. Alguns recursos podem não funcionar perfeitamente com o GLM Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    'A integração com IDE não é suportada no seu ambiente atual. Para usar este recurso, execute o GLM Code em um destes IDEs suportados: VS Code ou forks do VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage GLM Code hooks': 'Gerenciar hooks do GLM Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    'Este menu é somente leitura. Para adicionar ou modificar hooks, edite settings.json diretamente ou pergunte ao GLM Code.',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    'Para adicionar hooks, edite settings.json diretamente ou pergunte ao GLM.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    'Para modificar ou remover este hook, edite settings.json diretamente ou pergunte ao GLM.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    'Para reativar os hooks, remova "disableAllHooks" do settings.json ou pergunte ao GLM Code.',
  // Hooks - Source
  Project: 'Projeto',
  User: 'Usuário',
  Skill: 'Habilidade',
  ...
  'Right before GLM Code concludes its response':
    'Logo antes do GLM Code concluir sua resposta',
  ...
  'stdout shown to GLM': 'stdout mostrado ao GLM',
  ...
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    'Gerar um resumo do projeto e salvá-lo em .glm/PROJECT_SUMMARY.md',
  ...
  'Successfully added GLM.md files from the following directories if there are:\n- {{directories}}':
    'Arquivos GLM.md adicionados com sucesso dos seguintes diretórios, se houverem:\n- {{directories}}',
  ...
  'Run glm --debug to see error logs':
    'Execute glm --debug para ver os logs de erro',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'O nível gratuito do GLM OAuth foi descontinuado em 2026-04-15. Selecione Coding Plan ou API Key.',
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'O nível gratuito do GLM OAuth foi descontinuado em 2026-04-15. Por favor, selecione um modelo de outro provedor ou execute /auth para trocar.',
  '\n⚠ GLM OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ O nível gratuito do GLM OAuth foi descontinuado em 2026-04-15. Selecione outra opção.\n',
  'Paid \u00B7 Up to 6,000 requests/5 hrs \u00B7 All Alibaba Cloud Coding Plan Models':
    'Pago \u00B7 Até 6.000 solicitações/5 hrs \u00B7 Todos os modelos z.ai Coding Plan',
  ...
  'GLM OAuth Authentication': 'Autenticação GLM OAuth',
  ...
  'GLM OAuth Authentication Timeout':
    'Tempo Limite de Autenticação GLM OAuth',
  ...
  'Waiting for GLM OAuth authentication...':
    'Aguardando autenticação GLM OAuth...',
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valor GLM_DEFAULT_AUTH_TYPE inválido: "{{value}}". Valores válidos são: {{validValues}}',
  // ============================================================================
  // Dialogs - Model
  // ============================================================================
  ...
  "GLM Code won't ask before using allowed tools.":
    'O GLM Code não perguntará antes de usar ferramentas permitidas.',
  'GLM Code will ask before using these tools.':
    'O GLM Code perguntará antes de usar essas ferramentas.',
  'GLM Code is not allowed to use denied tools.':
    'O GLM Code não tem permissão para usar ferramentas negadas.',
  ...
  'Checked in at .glm/settings.json': 'Registrado em .glm/settings.json',
  'User settings': 'Configurações do usuário',
  'Saved in at ~/.glm/settings.json': 'Salvo em ~/.glm/settings.json',
  ...
  'GLM Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'O GLM Code pode ler arquivos na área de trabalho e fazer edições quando a aceitação automática está ativada.',
  'GLM Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'O GLM Code poderá ler arquivos neste diretório e fazer edições quando a aceitação automática está ativada.',
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    'Você pode executar quaisquer comandos shell do GLM Code usando ! (ex: !ls).',
  ...
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    'Você pode retomar uma conversa anterior executando glm --continue ou glm --resume.',
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    'Adicione um arquivo GLM.md para dar ao GLM Code um contexto persistente do projeto.',
  ...
  'Authenticate using GLM OAuth': 'Autenticar usando GLM OAuth',
  'Authenticate using Alibaba Cloud Coding Plan':
    'Autenticar usando z.ai Coding Plan',
  ...
  'Starting GLM OAuth authentication...':
    'Iniciando autenticação GLM OAuth...',
  'Successfully authenticated with GLM OAuth.':
    'Autenticado com sucesso via GLM OAuth.',
  'Failed to authenticate with GLM OAuth: {{error}}':
    'Falha ao autenticar com GLM OAuth: {{error}}',
  'Processing Alibaba Cloud Coding Plan authentication...':
    'Processando autenticação z.ai Coding Plan...',
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    'Autenticado com sucesso via z.ai Coding Plan.',
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - Autenticar com GLM OAuth (descontinuado)',
  'Or simply run:': 'Ou simplesmente execute:',
  '  glm auth                - Interactive authentication setup\n':
    '  glm auth                - Configuração interativa de autenticação\n',
  '✓ Authentication Method: GLM OAuth': '✓ Método de autenticação: GLM OAuth',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'O nível gratuito do GLM OAuth foi descontinuado em 2026-04-15. Execute /auth para mudar para Coding Plan, OpenRouter, Fireworks AI ou outro provedor.',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    '✓ Método de autenticação: z.ai Coding Plan',
  ...
  "Set up GLM Code's status line UI":
    'Configurar a interface da barra de status do GLM Code',
