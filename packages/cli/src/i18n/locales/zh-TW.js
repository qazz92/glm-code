...
// Traditional Chinese (zh-TW) translations for GLM Code CLI
...
export default {
  ...
  'for help on GLM Code': '獲取 GLM Code 幫助',
  ...
  'Analyzes the project and creates a tailored GLM.md file.':
    '分析項目並創建定製的 GLM.md 文件',
  'List available GLM Code tools. Usage: /tools [desc]':
    '列出可用的 GLM Code 工具。用法：/tools [desc]',
  'List available skills.': '列出可用技能。',
  'Available GLM Code CLI tools:': '可用的 GLM Code CLI 工具：',
  ...
  'Are you sure you want to delete agent "{{name}}"?':
    '您確定要刪除智能體 "{{name}}" 嗎？',
  'Project Level (.glm/agents/)': '項目級 (.glm/agents/)',
  'User Level (~/.glm/agents/)': '用戶級 (~/.glm/agents/)',
  ...
  'Generate with GLM Code (Recommended)': '使用 GLM Code 生成（推薦）',
  ...
  'not updatable': '不可更新',
  error: '錯誤',
  'View and edit GLM Code settings': '查看和編輯 GLM Code 設置',
  Settings: '設置',
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必須重啓 GLM Code。按 r 退出並立即應用更改。',
  'Vim Mode': 'Vim 模式',
  ...
  'How is GLM doing this session? (optional)': 'GLM 這次表現如何？（可選）',
  Bad: '不滿意',
  Fine: '還行',
  Good: '滿意',
  Dismiss: '忽略',
  ...
  'Respect .glmignore': '遵守 .glmignore',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    '此擴展將使用 {{fileName}} 向您的 GLM.md 上下文追加信息',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    '您正在安裝來自 {{originSource}} 的擴展。某些功能可能無法完美兼容 GLM Code。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    '您當前環境不支持 IDE 集成。要使用此功能，請在以下支持的 IDE 之一中運行 GLM Code：VS Code 或 VS Code 分支版本。',
  ...
  'Manage GLM Code hooks': '管理 GLM Code Hook',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    '此菜單爲只讀。要添加或修改 Hook，請直接編輯 settings.json 或詢問 GLM Code。',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    '要添加 Hook，請直接編輯 settings.json 或詢問 GLM。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    '要修改或刪除此 Hook，請直接編輯 settings.json 或詢問 GLM。',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    '要重新啓用 Hook，請從 settings.json 中刪除 "disableAllHooks" 或詢問 GLM Code。',
  Project: '項目',
  User: '用戶',
  Skill: '技能',
  System: '系統',
  ...
  'Right before GLM Code concludes its response': 'GLM Code 結束響應之前',
  ...
  'stdout shown to GLM': '向 GLM 顯示 stdout',
  ...
  'Run glm --debug to see error logs': '運行 glm --debug 查看錯誤日誌',
  ...
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    '生成項目摘要並保存到 .glm/PROJECT_SUMMARY.md',
  ...
  'Alibaba Cloud Token Plan': 'z.ai Token Plan',
  'Pay-as-you-go tokens · Configure ModelStudio standard API key':
    '按 Token 付費 · 配置 z.ai 標準 API Key',
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '無效的 GLM_DEFAULT_AUTH_TYPE 值："{{value}}"。有效值爲：{{validValues}}',
  'Select Model': '選擇模型',
  'API Key': 'API Key',
  '(default)': '(默認)',
  '(not set)': '(未設置)',
  ...
  'Checked in at .glm/settings.json': '保存在 .glm/settings.json',
  'User settings': '用戶設置',
  'Saved in at ~/.glm/settings.json': '保存在 ~/.glm/settings.json',
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    '在 GLM Code 中使用 ! 可運行任意 shell 命令（例如 !ls）。',
  ...
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    '運行 glm --continue 或 glm --resume 可繼續之前的會話。',
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    '添加 GLM.md 文件，爲 GLM Code 提供持久的項目上下文。',
  ...
  'Agent powering down. Goodbye!': 'GLM Code 正在關閉，再見！',
  ...
  'New model configurations are available for Alibaba Cloud Coding Plan. Update now?':
    'z.ai Coding Plan 有新模型配置可用。是否立即更新？',
  ...
  '↑/↓: Navigate | Enter: Select | Esc: Cancel':
    '↑/↓: 導航 | Enter: 選擇 | Esc: 取消',
  'Authenticate using GLM OAuth': '使用 GLM OAuth 進行認證',
  'Authenticate using Alibaba Cloud Coding Plan':
    '使用z.ai Coding Plan 進行認證',
  ...
  'Starting GLM OAuth authentication...': '正在啓動 GLM OAuth 認證...',
  'Successfully authenticated with GLM OAuth.': '已成功通過 GLM OAuth 認證。',
  'Failed to authenticate with GLM OAuth: {{error}}':
    'GLM OAuth 認證失敗：{{error}}',
  'Processing Alibaba Cloud Coding Plan authentication...':
    '正在處理z.ai Coding Plan 認證...',
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    '已成功通過z.ai Coding Plan 認證。',
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - 使用 GLM OAuth 登錄（已停用）',
  'Or simply run:': '或者直接運行：',
  '  glm auth                - Interactive authentication setup\n':
    '  glm auth                - 交互式認證配置\n',
  '✓ Authentication Method: GLM OAuth': '✓ 認證方式：GLM OAuth',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'GLM OAuth 免費額度已於 2026-04-15 停用。請運行 /auth 切換到 Coding Plan、OpenRouter、Fireworks AI 或其他服務商。',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    '✓ 認證方式：z.ai Coding Plan',
  '中国 (China) - 阿里云百炼': '中國 (China) - z.ai',
  'Global - Alibaba Cloud': '全球 - z.ai',
  '  Region: {{region}}': '  區域：{{region}}',
  '  Current Model: {{model}}': '  當前模型：{{model}}',
  '  Config Version: {{version}}': '  配置版本：{{version}}',
  '  Status: API key configured\n': '  狀態：API Key 已配置\n',
  '⚠️  Authentication Method: Alibaba Cloud Coding Plan (Incomplete)':
    '⚠️  認證方式：z.ai Coding Plan（不完整）',
  '  Issue: API key not found in environment or settings\n':
    '  問題：在環境變量或設置中未找到 API Key\n',
  '  Run `glm auth coding-plan` to re-configure.\n':
    '  運行 `glm auth coding-plan` 重新配置。\n',
  ...
  "Set up GLM Code's status line UI": '配置 GLM Code 的狀態欄',
