...
// Traductions françaises pour GLM Code CLI
...
export default {
  ...
  'for help on GLM Code': "pour l'aide de GLM Code",
  ...
  'Analyzes the project and creates a tailored GLM.md file.':
    'Analyse le projet et crée un fichier GLM.md personnalisé.',
  'List available GLM Code tools. Usage: /tools [desc]':
    'Lister les outils GLM Code disponibles. Utilisation : /tools [desc]',
  'List available skills.': 'Lister les compétences disponibles.',
  'Available GLM Code CLI tools:': 'Outils GLM Code CLI disponibles :',
  ...
  'open full GLM Code documentation in your browser':
    'ouvrir la documentation complète de GLM Code dans votre navigateur',
  ...
  // ============================================================================
  'Project Level (.glm/agents/)': 'Niveau projet (.glm/agents/)',
  'User Level (~/.glm/agents/)': 'Niveau utilisateur (~/.glm/agents/)',
  ...
  'Generate with GLM Code (Recommended)':
    'Générer avec GLM Code (Recommandé)',
  ...
  'View and edit GLM Code settings':
    'Voir et modifier les paramètres de GLM Code',
  Settings: 'Paramètres',
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    'Pour voir les changements, GLM Code doit être redémarré. Appuyez sur r pour quitter et appliquer les changements maintenant.',
  // ============================================================================
  ...
  'How is GLM doing this session? (optional)':
    'Comment se passe cette session avec GLM ? (facultatif)',
  Bad: 'Mauvais',
  Fine: 'Correct',
  Good: 'Bien',
  Dismiss: 'Ignorer',
  ...
  'Respect .glmignore': 'Respecter .glmignore',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    'Cette extension ajoutera des informations à votre contexte GLM.md en utilisant {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    'Vous installez une extension depuis {{originSource}}. Certaines fonctionnalités peuvent ne pas fonctionner parfaitement avec GLM Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    "L'intégration IDE n'est pas prise en charge dans votre environnement actuel. Pour utiliser cette fonctionnalité, exécutez GLM Code dans l'un des IDEs pris en charge : VS Code ou ses dérivés.",
  ...
  // Commandes - Hooks
  // ============================================================================
  'Manage GLM Code hooks': 'Gérer les hooks GLM Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    'Ce menu est en lecture seule. Pour ajouter ou modifier des hooks, éditez settings.json directement ou demandez à GLM Code.',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    'Pour ajouter des hooks, éditez settings.json directement ou demandez à GLM.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    'Pour modifier ou supprimer ce hook, éditez settings.json directement ou demandez à GLM.',
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    'Pour réactiver les hooks, supprimez "disableAllHooks" de settings.json ou demandez à GLM Code.',
  Project: 'Projet',
  User: 'Utilisateur',
  Skill: 'Compétence',
  System: 'Système',
  ...
  'Right before GLM Code concludes its response':
    'Juste avant que GLM Code conclue sa réponse',
  ...
  'stdout shown to GLM': 'stdout affiché à GLM',
  ...
  'Run glm --debug to see error logs':
    "Exécutez glm --debug pour voir les journaux d'erreurs",
  ...
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    "Générer un résumé du projet et l'enregistrer dans .glm/PROJECT_SUMMARY.md",
  ...
  'Successfully added GLM.md files from the following directories if there are:\n- {{directories}}':
    "Fichiers GLM.md ajoutés avec succès depuis les répertoires suivants s'ils existent :\n- {{directories}}",
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Le niveau gratuit GLM OAuth a été abandonné le 2026-04-15. Veuillez sélectionner Coding Plan ou API Key.',
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    "Le niveau gratuit de GLM OAuth a été abandonné le 2026-04-15. Veuillez sélectionner un modèle d'un autre fournisseur ou exécuter /auth pour changer.",
  '\n⚠ GLM OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ Le niveau gratuit GLM OAuth a été abandonné le 2026-04-15. Veuillez sélectionner une autre option.\n',
  'Paid \u00B7 Up to 6,000 requests/5 hrs \u00B7 All Alibaba Cloud Coding Plan Models':
    "Payant · Jusqu'à 6 000 requêtes/5h · Tous les modèles z.ai Coding Plan",
  ...
  'GLM OAuth Authentication': 'Authentification GLM OAuth',
  'Please visit this URL to authorize:':
    'Veuillez visiter cette URL pour autoriser :',
  'Waiting for authorization': "En attente d'autorisation",
  'Time remaining:': 'Temps restant :',
  'GLM OAuth Authentication Timeout': "Délai d'authentification GLM OAuth",
  ...
  'Waiting for GLM OAuth authentication...':
    "En attente de l'authentification GLM OAuth...",
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Valeur GLM_DEFAULT_AUTH_TYPE invalide : "{{value}}". Valeurs valides : {{validValues}}',
  // ============================================================================
  ...
  "GLM Code won't ask before using allowed tools.":
    "GLM Code ne demandera pas avant d'utiliser les outils autorisés.",
  'GLM Code will ask before using these tools.':
    "GLM Code demandera avant d'utiliser ces outils.",
  'GLM Code is not allowed to use denied tools.':
    "GLM Code n'est pas autorisé à utiliser les outils refusés.",
  ...
  'Checked in at .glm/settings.json': 'Validé dans .glm/settings.json',
  'User settings': 'Paramètres utilisateur',
  'Saved in at ~/.glm/settings.json': 'Enregistré dans ~/.glm/settings.json',
  ...
  'GLM Code can read files in the workspace, and make edits when auto-accept edits is on.':
    "GLM Code peut lire les fichiers dans l'espace de travail et effectuer des modifications lorsque l'acceptation automatique est activée.",
  'GLM Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    "GLM Code pourra lire les fichiers dans ce répertoire et effectuer des modifications lorsque l'acceptation automatique est activée.",
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    "Vous pouvez exécuter n'importe quelle commande shell depuis GLM Code en utilisant ! (ex. !ls).",
  ...
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    'Vous pouvez reprendre une conversation précédente en exécutant glm --continue ou glm --resume.',
  ...
  'Authenticate using GLM OAuth': 'Authentifier avec GLM OAuth',
  'Authenticate using Alibaba Cloud Coding Plan':
    'Authentifier avec z.ai Coding Plan',
  ...
  'Starting GLM OAuth authentication...':
    "Démarrage de l'authentification GLM OAuth...",
  'Successfully authenticated with GLM OAuth.':
    'Authentification réussie avec GLM OAuth.',
  'Failed to authenticate with GLM OAuth: {{error}}':
    "Échec de l'authentification avec GLM OAuth : {{error}}",
  'Processing Alibaba Cloud Coding Plan authentication...':
    "Traitement de l'authentification z.ai Coding Plan...",
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    'Authentification réussie avec z.ai Coding Plan.',
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - Authentification avec GLM OAuth (abandonné)',
  'Or simply run:': 'Ou simplement exécutez :',
  '  glm auth                - Interactive authentication setup\n':
    "  glm auth                - Configuration d'authentification interactive\n",
  '✓ Authentication Method: GLM OAuth':
    "✓ Méthode d'authentification : GLM OAuth",
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Le niveau gratuit GLM OAuth a été abandonné le 2026-04-15. Exécutez /auth pour passer à Coding Plan, OpenRouter, Fireworks AI ou un autre fournisseur.',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    "✓ Méthode d'authentification : z.ai Coding Plan",
  '中国 (China) - 阿里云百炼': '中国 (Chine) - z.ai',
  ...
  "Set up GLM Code's status line UI":
    "Configurer l'interface de la barre de statut de GLM Code",
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    'Ajoutez un fichier GLM.md pour donner à GLM Code un contexte de projet persistant.',
