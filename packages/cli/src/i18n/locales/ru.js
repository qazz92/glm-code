...
// Русский перевод для GLM Code CLI
...
export default {
  ...
  'for help on GLM Code': 'Справка по GLM Code',
  ...
  'Analyzes the project and creates a tailored GLM.md file.':
    'Анализ проекта и создание адаптированного файла GLM.md',
  'List available GLM Code tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов GLM Code. Использование: /tools [desc]',
  'List available skills.': 'Показать доступные навыки.',
  'Available GLM Code CLI tools:': 'Доступные инструменты GLM Code CLI:',
  ...
  'open full GLM Code documentation in your browser':
    'Открытие полной документации GLM Code в браузере',
  ...
  // ============================================================================
  'Project Level (.glm/agents/)': 'Уровень проекта (.glm/agents/)',
  'User Level (~/.glm/agents/)': 'Уровень пользователя (~/.glm/agents/)',
  ...
  'Generate with GLM Code (Recommended)':
    'Сгенерировать с помощью GLM Code (Рекомендуется)',
  ...
  // ============================================================================
  'View and edit GLM Code settings': 'Просмотр и изменение настроек GLM Code',
  Settings: 'Настройки',
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить GLM Code. Нажмите r для выхода и применения изменений.',
  // ============================================================================
  // Метки настроек
  // ============================================================================
  'Vim Mode': 'Режим Vim',
  ...
  'How is GLM doing this session? (optional)':
    'Как дела у GLM в этой сессии? (необязательно)',
  Bad: 'Плохо',
  Fine: 'Нормально',
  Good: 'Хорошо',
  Dismiss: 'Отклонить',
  ...
  'Respect .glmignore': 'Учитывать .glmignore',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    'Это расширение добавит информацию в ваш контекст GLM.md с помощью {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с GLM Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите GLM Code в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage GLM Code hooks': 'Управлять хуками GLM Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите GLM Code.',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    'Чтобы добавить хуки, отредактируйте settings.json напрямую или спросите GLM.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    'Чтобы изменить или удалить этот хук, отредактируйте settings.json напрямую или спросите GLM.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите GLM Code.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  Skill: 'Навык',
  ...
  'Right before GLM Code concludes its response':
    'Непосредственно перед завершением ответа GLM Code',
  ...
  'stdout shown to GLM': 'stdout показан GLM',
  ...
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    'Сгенерировать сводку проекта и сохранить её в .glm/PROJECT_SUMMARY.md',
  ...
  'Successfully added GLM.md files from the following directories if there are:\n- {{directories}}':
    'Успешно добавлены файлы GLM.md из следующих директорий (если они есть):\n- {{directories}}',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'Бесплатный уровень GLM OAuth прекращён 2026-04-15. Выберите Coding Plan или API Key.',
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'Бесплатный уровень GLM OAuth был прекращен 2026-04-15. Пожалуйста, выберите модель от другого провайдера или выполните /auth для переключения.',
  '\n⚠ GLM OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ Бесплатный уровень GLM OAuth прекращён 2026-04-15. Выберите другую опцию.\n',
  'Paid \u00B7 Up to 6,000 requests/5 hrs \u00B7 All Alibaba Cloud Coding Plan Models':
    'Платно \u00B7 До 6 000 запросов/5 часов \u00B7 Все модели z.ai Coding Plan',
  ...
  'GLM OAuth Authentication': 'Авторизация GLM OAuth',
  ...
  'GLM OAuth Authentication Timeout': 'Таймаут авторизации GLM OAuth',
  ...
  'Waiting for GLM OAuth authentication...':
    'Ожидание авторизации GLM OAuth...',
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Неверное значение GLM_DEFAULT_AUTH_TYPE: "{{value}}". Допустимые значения: {{validValues}}',
  // ============================================================================
  // Диалоги - Модель
  // ============================================================================
  ...
  "GLM Code won't ask before using allowed tools.":
    'GLM Code не будет спрашивать перед использованием разрешённых инструментов.',
  'GLM Code will ask before using these tools.':
    'GLM Code спросит перед использованием этих инструментов.',
  'GLM Code is not allowed to use denied tools.':
    'GLM Code не может использовать запрещённые инструменты.',
  ...
  'Checked in at .glm/settings.json': 'Зафиксировано в .glm/settings.json',
  'User settings': 'Пользовательские настройки',
  'Saved in at ~/.glm/settings.json': 'Сохранено в ~/.glm/settings.json',
  ...
  'GLM Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'GLM Code может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'GLM Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'GLM Code сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в GLM Code с помощью ! (например, !ls).',
  ...
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    'Вы можете продолжить предыдущий разговор, запустив glm --continue или glm --resume.',
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    'Добавьте файл GLM.md, чтобы предоставить GLM Code постоянный контекст проекта.',
  ...
  'Run glm --debug to see error logs':
    'Запустите glm --debug для просмотра журналов ошибок',
  ...
  'Authenticate using GLM OAuth': 'Аутентификация через GLM OAuth',
  'Authenticate using Alibaba Cloud Coding Plan':
    'Аутентификация через z.ai Coding Plan',
  ...
  'Starting GLM OAuth authentication...':
    'Запуск аутентификации GLM OAuth...',
  'Successfully authenticated with GLM OAuth.':
    'Успешная аутентификация через GLM OAuth.',
  'Failed to authenticate with GLM OAuth: {{error}}':
    'Ошибка аутентификации через GLM OAuth: {{error}}',
  'Processing Alibaba Cloud Coding Plan authentication...':
    'Обработка аутентификации z.ai Coding Plan...',
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    'Успешная аутентификация через z.ai Coding Plan.',
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - Аутентификация через GLM OAuth (прекращено)',
  'Or simply run:': 'Или просто выполните:',
  '  glm auth                - Interactive authentication setup\n':
    '  glm auth                - Интерактивная настройка аутентификации\n',
  '✓ Authentication Method: GLM OAuth': '✓ Метод аутентификации: GLM OAuth',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Бесплатный уровень GLM OAuth прекращён 2026-04-15. Выполните /auth для переключения на Coding Plan, OpenRouter, Fireworks AI или другого провайдера.',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    '✓ Метод аутентификации: z.ai Coding Plan',
  'Global - Alibaba Cloud': 'Глобальный - z.ai',
  ...
  '⚠️  Authentication Method: Alibaba Cloud Coding Plan (Incomplete)':
    '⚠️  Метод аутентификации: z.ai Coding Plan (Не завершён)',
  '  Issue: API key not found in environment or settings\n':
    '  Проблема: API Key не найден в окружении или настройках\n',
  '  Run `glm auth coding-plan` to re-configure.\n':
    '  Выполните `glm auth coding-plan` для повторной настройки.\n',
  ...
  "Set up GLM Code's status line UI":
    'Настроить интерфейс строки состояния GLM Code',
