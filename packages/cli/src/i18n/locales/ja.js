...
// Japanese translations for GLM Code CLI
...
export default {
  ...
  'for help on GLM Code': 'GLM Code のヘルプ',
  ...
  'Analyzes the project and creates a tailored GLM.md file.':
    'プロジェクトを分析し、カスタマイズされた GLM.md ファイルを作成',
  'List available GLM Code tools. Usage: /tools [desc]':
    '利用可能な GLM Code ツールを一覧表示。使い方: /tools [desc]',
  'List available skills.': '利用可能なスキルを一覧表示する。',
  'Available GLM Code CLI tools:': '利用可能な GLM Code CLI ツール:',
  ...
  'Project Level (.glm/agents/)': 'プロジェクトレベル (.glm/agents/)',
  'User Level (~/.glm/agents/)': 'ユーザーレベル (~/.glm/agents/)',
  ...
  'Generate with GLM Code (Recommended)': 'GLM Code で生成(推奨)',
  ...
  'To see changes, GLM Code must be restarted. Press r to exit and apply changes now.':
    '変更を確認するには GLM Code を再起動する必要があります。 r を押して終了し、変更を適用してください',
  'View and edit GLM Code settings': 'GLM Code の設定を表示・編集',
  Settings: '設定',
  'Vim Mode': 'Vim モード',
  'Output Format': '出力形式',
  'Hide Tips': 'ヒントを非表示',
  ...
  'Respect .glmignore': '.glmignore を優先',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with GLM Code.':
    '{{originSource}} から拡張機能をインストールしています。一部の機能は GLM Code で完全に動作しない可能性があります。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run GLM Code in one of these supported IDEs: VS Code or VS Code forks.':
    '現在の環境ではIDE連携はサポートされていません。この機能を使用するには、VS Code または VS Code 派生エディタで GLM Code を実行してください',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage GLM Code hooks': 'GLM Code のフックを管理する',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask GLM Code.':
    'このメニューは読み取り専用です。フックを追加または変更するには、settings.json を直接編集するか、GLM Code に尋ねてください。',
  ...
  'To add hooks, edit settings.json directly or ask GLM.':
    'フックを追加するには、settings.json を直接編集するか、GLM に尋ねてください。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask GLM to help.':
    'このフックを変更または削除するには、settings.json を直接編集するか、GLM に尋ねてください。',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask GLM Code.':
    'フックを再有効化するには、settings.json から "disableAllHooks" を削除するか、GLM Code に尋ねてください。',
  // Hooks - Source
  Project: 'プロジェクト',
  User: 'ユーザー',
  Skill: 'スキル',
  ...
  'stdout shown to GLM': 'stdout を GLM に表示',
  ...
  'Generate a project summary and save it to .glm/PROJECT_SUMMARY.md':
    'プロジェクトサマリーを生成し、.glm/PROJECT_SUMMARY.md に保存',
  ...
  'Successfully added GLM.md files from the following directories if there are:\n- {{directories}}':
    '以下のディレクトリから GLM.md ファイルを追加しました(存在する場合):\n- {{directories}}',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select Coding Plan or API Key instead.':
    'GLM OAuth 無料枠は 2026-04-15 に終了しました。Coding Plan または API Key を選択してください。',
  'GLM OAuth free tier was discontinued on 2026-04-15. Please select a model from another provider or run /auth to switch.':
    'GLM OAuth無料プランは2026-04-15に終了しました。他のプロバイダーのモデルを選択するか、/authを実行して切り替えてください。',
  '\n⚠ GLM OAuth free tier was discontinued on 2026-04-15. Please select another option.\n':
    '\n⚠ GLM OAuth 無料枠は 2026-04-15 に終了しました。他のオプションを選択してください。\n',
  'Paid \u00B7 Up to 6,000 requests/5 hrs \u00B7 All Alibaba Cloud Coding Plan Models':
    '有料 \u00B7 5時間最大6,000リクエスト \u00B7 すべての z.ai Coding Plan モデル',
  ...
  'Invalid GLM_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '無効な GLM_DEFAULT_AUTH_TYPE 値: "{{value}}"。有効な値: {{validValues}}',
  // Dialogs - Model
  'Select Model': 'モデルを選択',
  Modality: 'モダリティ',
  ...
  "GLM Code won't ask before using allowed tools.":
    'GLM Code は許可されたツールを使用する前に確認しません。',
  'GLM Code will ask before using these tools.':
    'GLM Code はこれらのツールを使用する前に確認します。',
  'GLM Code is not allowed to use denied tools.':
    'GLM Code は拒否されたツールを使用できません。',
  ...
  'Checked in at .glm/settings.json': '.glm/settings.json にチェックイン',
  'User settings': 'ユーザー設定',
  'Saved in at ~/.glm/settings.json': '~/.glm/settings.json に保存',
  ...
  'GLM Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'GLM Code はワークスペース内のファイルを読み取り、自動編集承認が有効な場合は編集を行えます。',
  'GLM Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'GLM Code はこのディレクトリ内のファイルを読み取り、自動編集承認が有効な場合は編集を行えます。',
  ...
  'You can run any shell commands from GLM Code using ! (e.g. !ls).':
    'GLM Code から ! を使って任意のシェルコマンドを実行できます（例: !ls）。',
  ...
  'You can resume a previous conversation by running glm --continue or glm --resume.':
    'glm --continue または glm --resume で前の会話を再開できます。',
  ...
  'Add a GLM.md file to give GLM Code persistent project context.':
    'GLM.md ファイルを追加すると、GLM Code に永続的なプロジェクトコンテキストを与えられます。',
  ...
  'Authenticate using GLM OAuth': 'GLM OAuth で認証する',
  'Authenticate using Alibaba Cloud Coding Plan':
    'z.ai Coding Plan で認証する',
  ...
  'Starting GLM OAuth authentication...': 'GLM OAuth 認証を開始しています...',
  'Successfully authenticated with GLM OAuth.':
    'GLM OAuth での認証に成功しました。',
  'Failed to authenticate with GLM OAuth: {{error}}':
    'GLM OAuth での認証に失敗しました: {{error}}',
  'Processing Alibaba Cloud Coding Plan authentication...':
    'z.ai Coding Plan 認証を処理しています...',
  'Successfully authenticated with Alibaba Cloud Coding Plan.':
    'z.ai Coding Plan での認証に成功しました。',
  ...
  '  glm auth glm-oauth     - Authenticate with GLM OAuth (discontinued)':
    '  glm auth glm-oauth     - GLM OAuth で認証（終了）',
  'Or simply run:': 'または以下を実行:',
  '  glm auth                - Interactive authentication setup\n':
    '  glm auth                - インタラクティブ認証セットアップ\n',
  '✓ Authentication Method: GLM OAuth': '✓ 認証方法: GLM OAuth',
  ...
  'GLM OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'GLM OAuth 無料枠は 2026-04-15 に終了しました。/auth を実行して Coding Plan、OpenRouter、Fireworks AI、または他のプロバイダーに切り替えてください。',
  '✓ Authentication Method: Alibaba Cloud Coding Plan':
    '✓ 認証方法: z.ai Coding Plan',
  'Global - Alibaba Cloud': 'グローバル - z.ai',
  '  Region: {{region}}': '  リージョン: {{region}}',
  '  Current Model: {{model}}': '  現在のモデル: {{model}}',
  '  Config Version: {{version}}': '  設定バージョン: {{version}}',
  '  Status: API key configured\n': '  ステータス: API Key 設定済み\n',
  '⚠️  Authentication Method: Alibaba Cloud Coding Plan (Incomplete)':
    '⚠️  認証方法: z.ai Coding Plan（不完全）',
  '  Issue: API key not found in environment or settings\n':
    '  問題: 環境変数または設定に API Key が見つかりません\n',
  '  Run `glm auth coding-plan` to re-configure.\n':
    '  `glm auth coding-plan` を実行して再設定してください。\n',
  ...
  "Set up GLM Code's status line UI": 'GLM Code のステータスライン UI を設定',
  ...
  'This extension will append info to your GLM.md context using {{fileName}}':
    'この拡張機能は {{fileName}} を使って GLM.md コンテキストに情報を追記します',
