 ...
 * This file handles the creation and maintenance of ~/.glm/output-language.md
...
const LLM_OUTPUT_LANGUAGE_MARKER_PREFIX = 'glm-code:llm-output-language:';
...
/**
 * Returns the path to the LLM output language rule file (~/.glm/output-language.md).
 */
...
function parseOutputLanguageFromContent(content: string): string | null {
  // Primary: machine-readable marker (e.g., <!-- glm-code:llm-output-language: 中文 -->)
