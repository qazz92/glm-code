...
import { OutputFormat } from '@glm-code/core';
...
describe('gemini.tsx main function', () => {
  ...
  let originalEnvGLMCodeSimple: string | undefined;
  let initialUnhandledRejectionListeners: NodeJS.UnhandledRejectionListener[] =
    [];

  beforeEach(() => {
    // Store and clear sandbox-related env variables to ensure a consistent test environment
    originalEnvGeminiSandbox = process.env['GLM_SANDBOX'];
    originalEnvSandbox = process.env['SANDBOX'];
    originalEnvGLMCodeSimple = process.env['GLM_CODE_SIMPLE'];
    delete process.env['GLM_SANDBOX'];
    delete process.env['SANDBOX'];
    delete process.env['GLM_CODE_SIMPLE'];
  ...
  afterEach(() => {
    ...
    if (originalEnvGeminiSandbox !== undefined) {
      process.env['GLM_SANDBOX'] = originalEnvGeminiSandbox;
    } else {
      delete process.env['GLM_SANDBOX'];
    }
    ...
    if (originalEnvGLMCodeSimple !== undefined) {
      process.env['GLM_CODE_SIMPLE'] = originalEnvGLMCodeSimple;
    } else {
      delete process.env['GLM_CODE_SIMPLE'];
    }
...
describe('gemini.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['GLM_CODE_NO_RELAUNCH'];
    process.env['GLM_CODE_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['GLM_CODE_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['GLM_CODE_NO_RELAUNCH'];
    }
    vi.restoreAllMocks();
  });
