...
import type { Config, ChatRecord } from '@glm-code/core';
import type {
  InsightData,
  SessionFacets,
...
import { read as readJsonlFile } from '@glm-code/core';
    ...
    it('should aggregate satisfaction counts', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          GLM_helpfulness: 'moderately_helpful',
    ...
    it('should aggregate primary success excluding none', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          user_satisfaction_counts: {},
          GLM_helpfulness: 'slightly_helpful',
