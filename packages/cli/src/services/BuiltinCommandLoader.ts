...
import { planReviewCommand } from '../ui/commands/planReviewCommand.js';
...
import {
  ...
  criticCommand,
  skillifyCommand,
} from '../ui/commands/workflowCommands.js';
...
import {
  ...
  autoCommand,
  visualVerdictCommand,
  aiSlopCleanerCommand,
  externalContextCommand,
  ccgCommand,
  pluginCommand,
} from '../ui/commands/extraCommands.js';

const builtinDebugLogger = createDebugLogger('BUILTIN_COMMAND_LOADER');

/**
 * Loads the core, hard-coded slash commands that are an integral part
 * of the GLM Code application.
 */
