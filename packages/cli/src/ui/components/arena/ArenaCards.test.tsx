...
import { AgentStatus } from '@glm-code/core';
...
describe('ArenaSessionCard', () => {
  ...
  it('hides empty per-agent unique file groups', () => {
    ...
    expect(output).not.toContain('only glm2.5:14b: none');
  });
});
