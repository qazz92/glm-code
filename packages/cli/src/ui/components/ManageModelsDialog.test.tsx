...
describe('ManageModelsDialog helpers', () => {
  it('buildModelLabel uses the short display label only', () => {
    expect(
      buildModelLabel(
        makeEntry('glm/glm3-coder:free', {
          badges: ['free', 'vision'],
          contextWindowSize: 1_000_000,
        }),
      ),
    ).toBe('glm/glm3-coder:free');
  });

  it.each<[FilterMode, string[]]>([
    ['all', ['glm/glm3-coder:free', 'openai/gpt-4o-mini']],
    ['enabled', ['openai/gpt-4o-mini']],
    ['free', ['glm/glm3-coder:free']],
    ['vision', ['glm/glm3-coder:free']],
