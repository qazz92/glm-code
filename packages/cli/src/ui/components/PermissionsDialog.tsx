...
import { isPathWithinRoot, parseRule } from '@glm-code/core';
  ...
  return [
    {
      ...
      description: t('Checked in at .glm/settings.json'),
      value: SettingScope.Workspace,
      key: 'project',
    },
    {
      label: t('User settings'),
      description: t('Saved in at ~/.glm/settings.json'),
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("GLM Code won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('GLM Code will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('GLM Code is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
