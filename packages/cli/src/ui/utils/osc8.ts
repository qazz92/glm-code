 ...
 *
 *   2. `GLM_DISABLE_HYPERLINKS=1` is a hard opt-out (e.g. for users whose
...
export function supportsHyperlinks(
  ...
  if (env['GLM_DISABLE_HYPERLINKS'] === '1') return false;
