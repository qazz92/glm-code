...
import type { Config, FileSearch } from '@glm-code/core';
import { FileSearchFactory, escapePath } from '@glm-code/core';
    ...
    const initialize = async () => {
      try {
        const searcher = FileSearchFactory.create({
          ...
          useGLMignore:
            config?.getFileFilteringOptions()?.respectGLMIgnore ?? true,
          cache: true,
