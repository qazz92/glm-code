...
| `authType`               | `'openai' \| 'glm-oauth'`                     | `'openai'`       | Authentication type for the AI service. Using `'glm-oauth'` in SDK is not recommended as credentials are stored in `~/.qwen` and may need periodic refresh.                                                                                                                                                                                                                                                                                                                          |
...
Version 0.1.0 requires [Qwen Code](https://github.com/GLMLabs/qwen-code) **>= 0.4.0** to be installed separately and accessible in your PATH.
