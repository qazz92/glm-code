...
export function NavToc() {
  return (
    <nav className="nav-toc">
      ...
      <a href="#section-usage">How You Use GLM Code</a>
    ...
    <>
      ...
      >
        {primarySuccess && Object.keys(primarySuccess).length > 0 && (
          <HorizontalBarChart
            data={primarySuccess}
            title="What Helped Most (GLM's Capabilities)"
            color="#3b82f6"
            allowedKeys={[
...
// GLM.md Additions Section Component
function GLMMdAdditionsSection({
  additions,
}: {
  additions: NonNullable<
    NonNullable<QualitativeData['improvements']>['GLM_md_additions']
  >;
}) {
  ...
  return (
    <div className="glm-md-section">
      <h3>Suggested GLM.md Additions</h3>
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into GLM Code to add it to your GLM.md.
      </p>

      <div className="glm-md-actions" style={{ marginBottom: '12px' }}>
        <button
      ...
      {additions.map((item, idx) => (
        <div key={idx} className="glm-md-item">
          <input
            type="checkbox"
  ...
  return (
    <>
      <h2
        ...
        className="text-xl font-semibold text-slate-900 mt-8 mb-4"
      >
        Existing GLM Code Features to Try
      </h2>

      {/* GLM.md Additions */}
      {Array.isArray(improvements.GLM_md_additions) &&
        improvements.GLM_md_additions.length > 0 && (
          <GLMMdAdditionsSection additions={improvements.GLM_md_additions} />
        )}

      <p className="text-xs text-slate-500 mb-3">
        Just copy this into GLM Code and it&apos;ll set it up for you.
      </p>
      ...
      <h2
        ...
        className="text-xl font-semibold text-slate-900 mt-8 mb-4"
      >
        New Ways to Use GLM Code
      </h2>
      <p className="text-xs text-slate-500 mb-3">
        Just copy this into GLM Code and it&apos;ll walk you through it.
      </p>
          ...
          improvements.usage_patterns.map((pat, idx) => (
            <div key={idx} className="pattern-card">
              ...
              <div className="copyable-prompt-section">
                <div className="prompt-label">Paste into GLM Code:</div>
