package ai.glm.acp.sdk.protocol.agent.request.terminal;

import java.util.List;

import ai.glm.acp.sdk.protocol.domain.terminal.EnvVariable;
import ai.glm.acp.sdk.protocol.jsonrpc.Meta;
import ai.glm.acp.sdk.protocol.jsonrpc.Request;
import com.alibaba.fastjson2.annotation.JSONType;

import static ai.glm.acp.sdk.protocol.agent.request.terminal.CreateTerminalRequest.CreateTerminalRequestParams;
