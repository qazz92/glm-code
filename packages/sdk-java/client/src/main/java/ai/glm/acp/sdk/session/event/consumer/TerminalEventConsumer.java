package ai.glm.acp.sdk.session.event.consumer;
...
import ai.glm.acp.sdk.protocol.client.response.terminal.CreateTerminalResponse.CreateTerminalResponseResult;
import ai.glm.acp.sdk.protocol.client.response.terminal.KillTerminalCommandResponse.KillTerminalCommandResponseResult;
import ai.glm.acp.sdk.protocol.client.response.terminal.ReleaseTerminalResponse.ReleaseTerminalResponseResult;
import ai.glm.acp.sdk.protocol.client.response.terminal.TerminalOutputResponse.TerminalOutputResponseResult;
import ai.glm.acp.sdk.protocol.client.response.terminal.WaitForTerminalExitResponse.WaitForTerminalExitResponseResult;
