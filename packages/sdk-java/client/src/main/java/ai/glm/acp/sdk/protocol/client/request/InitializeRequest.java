package ai.glm.acp.sdk.protocol.client.request;

import ai.glm.acp.sdk.protocol.domain.client.ClientCapabilities;
import ai.glm.acp.sdk.protocol.domain.client.ClientInfo;
import ai.glm.acp.sdk.protocol.jsonrpc.Meta;
import ai.glm.acp.sdk.protocol.jsonrpc.Request;
import com.alibaba.fastjson2.annotation.JSONType;

import static ai.glm.acp.sdk.protocol.client.request.InitializeRequest.InitializeRequestParams;
