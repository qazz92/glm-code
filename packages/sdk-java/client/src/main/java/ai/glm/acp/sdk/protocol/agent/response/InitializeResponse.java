...
import ai.glm.acp.sdk.protocol.domain.agent.AgentCapabilities;
import ai.glm.acp.sdk.protocol.domain.agent.AgentInfo;
import ai.glm.acp.sdk.protocol.domain.agent.AuthMethod;
import ai.glm.acp.sdk.protocol.jsonrpc.Response;

import static ai.glm.acp.sdk.protocol.agent.response.InitializeResponse.InitializeResponseResult;
