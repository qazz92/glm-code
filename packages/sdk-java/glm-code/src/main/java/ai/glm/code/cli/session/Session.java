package ai.glm.code.cli.session;
...
import ai.glm.code.cli.protocol.data.Capabilities;
import ai.glm.code.cli.protocol.data.PermissionMode;
import ai.glm.code.cli.protocol.message.SDKResultMessage;
import ai.glm.code.cli.protocol.message.SDKSystemMessage;
import ai.glm.code.cli.protocol.message.SDKUserMessage;
import ai.glm.code.cli.protocol.message.assistant.SDKAssistantMessage;
import ai.glm.code.cli.protocol.message.assistant.SDKPartialAssistantMessage;
import ai.glm.code.cli.protocol.message.control.payload.CLIControlInitializeRequest;
import ai.glm.code.cli.protocol.message.control.payload.CLIControlInitializeResponse;
import ai.glm.code.cli.protocol.message.control.payload.CLIControlInterruptRequest;
import ai.glm.code.cli.protocol.message.control.CLIControlRequest;
import ai.glm.code.cli.protocol.message.control.CLIControlResponse;
import ai.glm.code.cli.protocol.message.control.payload.CLIControlSetModelRequest;
import ai.glm.code.cli.protocol.message.control.payload.CLIControlSetPermissionModeRequest;
import ai.glm.code.cli.protocol.message.control.payload.ControlRequestPayload;
import ai.glm.code.cli.protocol.message.control.payload.ControlResponsePayload;
import ai.glm.code.cli.session.event.consumers.SessionEventConsumers;
import ai.glm.code.cli.session.exception.SessionControlException;
import ai.glm.code.cli.session.exception.SessionSendPromptException;
...
/**
 * Manages a session with the GLM Code CLI, handling communication, sending prompts, and processing responses.
 *
...
public class Session {
     ...
     * @throws ai.glm.code.cli.session.exception.SessionControlException if the transport is not available
     */
     ...
     *
     * @throws ai.glm.code.cli.session.exception.SessionControlException if initialization fails
     */
     ...
     *
     * @throws ai.glm.code.cli.session.exception.SessionControlException if closing fails
     */
     ...
     * @throws ai.glm.code.cli.session.exception.SessionControlException if the operation fails
     */
     ...
     * @throws ai.glm.code.cli.session.exception.SessionSendPromptException if sending the prompt fails
     * @throws ai.glm.code.cli.session.exception.SessionControlException if a control operation fails
     */
