package ai.glm.code.cli.transport;
...
public class TransportOptions implements Cloneable {
    /**
     * Path to the GLM executable.
     */
    private String pathToGLMExecutable;
    /**
    ...
    /**
     * Gets the path to the GLM executable.
     *
     * @return The path to the GLM executable
     */
    public String getPathToGLMExecutable() {
        return pathToGLMExecutable;
    }

    /**
     * Sets the path to the GLM executable.
     *
     * @param pathToGLMExecutable The path to the GLM executable
     * @return This instance for method chaining
     */
    public TransportOptions setPathToGLMExecutable(String pathToGLMExecutable) {
        this.pathToGLMExecutable = pathToGLMExecutable;
        return this;
    }
