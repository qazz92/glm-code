package ai.glm.code.cli.protocol.message;
...
public class SDKSystemMessage extends MessageBase {
     ...
     * GLM Code version.
     */
    @JSONField(name = "glm_code_version")
    private String glmCodeVersion;
    /**
     * Output style.
     */
    ...
    /**
     * Gets the GLM Code version.
     *
     * @return The GLM Code version
     */
    public String getGLMCodeVersion() {
        return glmCodeVersion;
    }

    /**
     * Sets the GLM Code version.
     *
     * @param glmCodeVersion The GLM Code version
     */
    public void setGLMCodeVersion(String glmCodeVersion) {
        this.glmCodeVersion = glmCodeVersion;
    }
