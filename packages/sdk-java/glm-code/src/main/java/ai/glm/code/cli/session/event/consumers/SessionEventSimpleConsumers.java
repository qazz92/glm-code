package ai.glm.code.cli.session.event.consumers;
...
import ai.glm.code.cli.protocol.data.behavior.Allow;
import ai.glm.code.cli.protocol.data.behavior.Behavior;
...
import ai.glm.code.cli.protocol.message.assistant.block.ContentBlock;
import ai.glm.code.cli.protocol.message.assistant.event.ContentBlockDeltaEvent;
import ai.glm.code.cli.protocol.message.assistant.event.StreamEvent;
import ai.glm.code.cli.protocol.message.control.payload.CLIControlPermissionRequest;
import ai.glm.code.cli.protocol.message.control.payload.CLIControlPermissionResponse;
...
public class SessionEventSimpleConsumers implements SessionEventConsumers {
     ...
     *
     * @param session a {@link ai.glm.code.cli.session.Session} object.
     * @param assistantContent a {@link ai.glm.code.cli.protocol.data.AssistantContent} object.
     */
