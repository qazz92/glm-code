...
class TransportOptionsAdapter {
    ...
    String[] buildCommandArgs() {
        List<String> args = new ArrayList<>(
                Arrays.asList(transportOptions.getPathToGLMExecutable(), "--input-format", "stream-json", "--output-format",
    ...
    private TransportOptions addDefaultTransportOptions(TransportOptions userTransportOptions) {
        ...
        if (StringUtils.isBlank(transportOptions.getPathToGLMExecutable())) {
            transportOptions.setPathToGLMExecutable("glm");
        }
