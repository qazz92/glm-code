package ai.glm.code.cli.example;
...
import ai.glm.code.cli.protocol.message.assistant.block.TextBlock;
...
public class SessionExample {
    ...
    public static void runSetModelExample(Session session) {
        try {
            ...
            Optional<Boolean> modelChangeResult = session.setModel("glm-4.5-air");
            ...
            Optional<Boolean> modelChangeResult2 = session.setModel("glm-5.1");
