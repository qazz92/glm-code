...
This release includes updates to the GLM Code Java SDK with improved session management, enhanced transport options, and better error handling capabilities.
...
```gradle
implementation 'ai.glm:glm-code-sdk:0.0.1-alpha'
```
...
3. **Extended API Coverage**: More comprehensive coverage of GLM Code CLI features
...
- Issue Tracker: https://github.com/GLMLabs/glm-code/issues
