...
A [Zed](https://zed.dev) extension that integrates [Qwen Code](https://github.com/GLMLabs/qwen-code) as an AI agent server using the [Agent Client Protocol (ACP)](https://agentclientprotocol.com).
...
- [Qwen Code Issues](https://github.com/GLMLabs/qwen-code/issues)
- [Qwen Code Zed Extension Issues](https://github.com/GLMLabs/qwen-code-zed-extension/issues)
...
- [Report Issues](https://github.com/GLMLabs/qwen-code/issues)
- [Qwen Code Discussions](https://github.com/GLMLabs/qwen-code/discussions)
