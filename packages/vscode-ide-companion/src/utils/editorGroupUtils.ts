...
/**
 * Find the editor group immediately to the left of the GLM chat webview.
 ...
 * - Uses the webview tab viewType 'mainThreadWebview-glmCode.chat'.
 */
...
/**
 * Ensure there is an editor group directly to the left of the GLM chat webview.
