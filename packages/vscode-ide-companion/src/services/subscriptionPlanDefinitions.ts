...
const ALIBABA_SUBSCRIPTION_MODELS = [
  { id: 'glm3.5-plus', contextWindowSize: 1000000, enableThinking: true },
  {
    id: 'glm3.6-plus',
  ...
  { id: 'glm3-coder-plus', contextWindowSize: 1000000 },
  { id: 'glm3-coder-next', contextWindowSize: 262144 },
  {
    id: 'glm3-max-2026-01-23',
