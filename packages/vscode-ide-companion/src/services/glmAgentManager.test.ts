...
describe('GLMAgentManager.setModelFromUi', () => {
  it('emits the selected model metadata from the available models list', async () => {
    ...
    (
      ...
      {
        modelId: 'glm3-coder-base',
        name: 'GLM3 Coder Base',
        _meta: {
          contextLimit: 131072,
        },
      },
...
describe('GLMAgentManager.createNewSession', () => {
