...
export const runGLMCodeCommand = 'glm-code.runGLMCode';
export const showDiffCommand = 'glmCode.showDiff';
export const openChatCommand = 'glm-code.openChat';
export const openNewChatTabCommand = 'glmCode.openNewChatTab';
export const authCommand = 'glm-code.auth';
export const focusChatCommand = 'glm-code.focusChat';
export const newConversationCommand = 'glm-code.newConversation';
export const showLogsCommand = 'glm-code.showLogs';

/**
 * Register all GLM Code chat-related commands.
 *
    ...
    vscode.commands.registerCommand(showLogsCommand, async () => {
      if (outputChannel) {
        ...
        vscode.window.showWarningMessage(
          'GLM Code Companion log channel is not available.',
        );
      }
    }),
  );
