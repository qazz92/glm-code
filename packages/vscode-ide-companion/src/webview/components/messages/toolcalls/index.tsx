 ...
 * All UI components are now imported from @glm-code/webui
 */

import { shouldShowToolCall, getToolCallComponent } from '@glm-code/webui';
import type { FC } from 'react';
import type { BaseToolCallProps } from '@glm-code/webui';
...
export type { BaseToolCallProps, ToolCallData } from '@glm-code/webui';
