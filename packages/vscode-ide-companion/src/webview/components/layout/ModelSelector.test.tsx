...
const discontinuedModel: ModelInfo = {
  modelId: 'glm3-coder-plus(glm-oauth)',
...
describe('ModelSelector — discontinued state (Issue #3745)', () => {
  it('renders the (Discontinued) badge for non-runtime GLM OAuth models', () => {
  ...
  it('does NOT mark a runtime GLM OAuth snapshot as discontinued', () => {
    const { container } = renderModelSelector({
  ...
  it('keeps a runtime GLM OAuth snapshot selectable', () => {
