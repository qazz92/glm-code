...
import type { GLMAgentManager } from '../../services/glmAgentManager.js';
...
vi.mock(
  '@glm-code/core/src/services/fileDiscoveryService.js',
  () => ({
...
vi.mock('@glm-code/core/src/utils/filesearch/fileSearch.js', () => ({
  FileSearchFactory: {
    create: () => fileSearchMock,
  },
}));
vi.mock('@glm-code/core/src/utils/filesearch/crawlCache.js', () => ({
  clear: vi.fn(),
}));
