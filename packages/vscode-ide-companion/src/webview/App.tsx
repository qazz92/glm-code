...
import type { PermissionOption, PermissionToolCall } from '@glm-code/webui';
...
function findMessageIndex(
  ...
  // .glm-message class (e.g. InterruptedMessage does not).
  ...
  useEffect(() => {
    const clearEditingOnRestoreOrFailure = (event: MessageEvent) => {
      ...
      if (
        ...
        message?.type === 'glmSessionSwitched' ||
  ...
  return (
    <div className="chat-container relative">
      ...
      <ChatHeader
        ...
        onLoadSessions={sessionManagement.handleLoadGLMSessions}
        onNewSession={() =>
          sessionManagement.handleNewGLMSession(modelInfo?.modelId ?? null)
        }
      />
