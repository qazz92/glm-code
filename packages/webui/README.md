...
A shared React component library for GLM Code applications, providing cross-platform UI components with consistent styling and behavior.
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@glm-code/webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@glm-code/webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
    ...
    <script type="text/babel">
      // Access components from the global GLMCodeWebUI object
      const { ChatViewer } = GLMCodeWebUI;
...
```tsx
import { Button, Input, Tooltip } from '@glm-code/webui';
import { PlatformProvider } from '@glm-code/webui/context';
...
```tsx
import { Button } from '@glm-code/webui';
...
```tsx
import { Input } from '@glm-code/webui';
...
```tsx
import { Tooltip } from '@glm-code/webui';
...
```tsx
import { FileIcon, FolderIcon, CheckIcon } from '@glm-code/webui/icons';
...
```tsx
import { PlatformProvider, usePlatform } from '@glm-code/webui/context';
...
// tailwind.config.js
module.exports = {
  presets: [require('@glm-code/webui/tailwind.preset.cjs')],
  // your customizations
};
```
