...
/**
 * Message part containing text content (GLM format)
 */
 ...
 * Supports both GLM format and Claude format
 */
...
/**
 * Extract text content from message (supports both GLM and Claude formats)
 */
function extractContent(message: ChatMessageData['message']): string {
  if (!message) return '';

  // GLM format: message.parts[].text
